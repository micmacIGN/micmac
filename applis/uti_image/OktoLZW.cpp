    ...
    (
     ...
     )
     {
           ...
           if (aTif.mode_compr() != Tiff_Im::LZW_Compr)
           {
                 ...
                 std::string aName = *itS + "LZW.tif";
                 Tiff_Im aTOut = Tiff_Im 
                                 (
                                      aName.c_str(),
                                      aTif.sz(),
                                      aTif.type_el(),
                  ...
                  ELISE_COPY ( aTif.all_pts(), aTif.in() & Masq, aTOut.out());

                  INT aDif;
                  ELISE_COPY ( aTif.all_pts(), Abs((aTif.in()&Masq)- aTOut.in()),sigma(aDif));
