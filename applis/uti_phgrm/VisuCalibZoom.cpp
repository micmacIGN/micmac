...
class cOneCalib
{
    public :
       ...
       (
           ...
           const cOneCalib2Visu & aC2V
       )  :
          mGrid    (aXMLM,aDir,aC2V.Name())
       {
       }
...
class cAppliVisuCalib
{
    public :
       cAppliVisuCalib
       (
            const cVisuCalibZoom & aVCZ
       )
       {
       }
};
...
using namespace NS_VisuCalibZoom;
using namespace NS_ParamChantierPhotogram;
...
int main(int argc,char ** argv)
{
    ...
    cVisuCalibZoom aECG = StdGetObjFromFile<cVisuCalibZoom>
                            (
				   argv[1],
