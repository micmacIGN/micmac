...
xml_mmvii_localparamters = glob.glob("../MMVII-LocalParameters/*.xml")
xml_gen_files = glob.glob("../../include/XML_GEN/*.xml")

#print("xml_micmac_files ",xml_micmac_files)
#print("xml_mmvii_localparamters ",xml_mmvii_localparamters)
#print("xml_gen_files ",xml_gen_files)
