...
%   \item Allégation :  marche aussi sans modèle, minimise globalement le critère d'erreur,         formulation théorique de l'ambiguité et des condition d'existence d'un crière épipolaire;        mesure de "l'épipolarabilité" d'un couple;
 %
\end{enumerate}}
