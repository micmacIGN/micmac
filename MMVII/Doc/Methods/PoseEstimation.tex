...
\begin{equation}
    c = \vec B . \vec n = [\vec B,\vec u_1,\vec U_2] = [\vec B,\vec u_1, R \vec u_2]
\end{equation}
...
\begin{equation}
    c =  [\vec B_0 + d_a \vec \alpha + d_b \vec \beta,\vec u_1, R_0 \vec u_2 + d_{\vec \omega }  \wedge   R_0 \vec u_2]
\end{equation}

Noting the none value $ R_0 \vec u_2= \vec U^0_2$

\begin{equation}
    c =  [\vec B_0 + d_a \vec \alpha + d_b \vec \beta,\vec u_1, \vec U^0_2  + d_{\vec \omega }  \wedge   \vec U^0_2]
\end{equation}

Neglegting, $2^{nd}$ order infinitesimal,  and noting $\vec N_0= \vec u_1 \wedge \vec U^0_2 $ we have :

\begin{equation}
    c =  (\vec B_0 + d_a \vec \alpha + d_b \vec \beta) . \vec N_0
...
\begin{equation}
    c =  \vec B_0 . \vec N_0 +  (\vec \alpha . \vec N_0) d_a  +  (\vec \beta . \vec N_0) d_b
