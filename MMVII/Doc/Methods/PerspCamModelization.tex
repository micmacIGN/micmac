...
\;\;\;  ;  \;\;\;
        \pi_0  \tran  R = \mathcal{H}_R  \pi_0
\end{equation}

We now go back to equation~\ref{FormImage1}, and for any rotation $R'$, we insert it using $^t R'R'=Id$ :

\begin{equation}
	   \mathcal{I} \pi_0   \tran R = \mathcal{I}  \pi_0   \tran R' R' \circ \tran R
\end{equation}

Or :

\begin{equation}
	   \mathcal{I} \pi_0   \tran R 
	   = (\mathcal{I} \mathcal{H}_R)   \pi_0   \tran (R \tran R')  \label{FormRotCalib}
\end{equation}
