...
The case where $\mathcal{S}^h \subset \mathcal{S}^i$ is obviously a dangerous case for computing 
calibration because we will have an infinite number of solution. This will be the case
