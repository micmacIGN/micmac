...
\section{Sensor inclination, and $PP_a\neq PP_s$ }
...
So with this approximation, and analyzing formula~\ref{HDH}, we see
that the parametric model of sensor inclination can me made with
a radial distorsion, where the center of distorsion ($PP_s$) is different from
the projection of center on the plane ($PP_a$).
