...
line segment, this is illustrated by figure~\ref{fig:Dioptr}.  We wil establish properpty between $B_k$ and $B_{k+1}$ and,
by recurence, this will establish the property for $B_n=B'$.


\subsection{Property 1}

We will want to establish that all $B_k$ intersect the axe $\mathcal{A}$.
