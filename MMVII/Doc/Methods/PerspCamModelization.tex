...
$\vec{k}$ correspond to a rotation of angle $\theta_k$ :
...
We can omit the constant term $1$ in results of equation \ref{EqDerTetax} and \ref{EqDerTetay} and obtain a base
