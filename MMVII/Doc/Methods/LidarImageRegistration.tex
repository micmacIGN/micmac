...
acquisition and image acquisition.  It describes not only the theory and equations,
but also some consideration about how to integrate it in \PPP.

The theoretical hypothesis are:

\begin{itemize}
   \item  the lidar is the reference (it will not move) and that's the images localisation parameters that will be modified; doing it in the reverse way would require
...
mainly from practical aspect, but also from theoretical aspects (the classical question
of mixing equations of different nature).
