...
\newcommand{\AttrV}{A_V}
\newcommand{\AttrEOr}{A_{\vec{e}}}
\newcommand{\AttrESym}{A_{\overline{E}}}

\newcommand{\ObjGr}[1]{\ensuremath #1<\AttrV,\AttrEOr,\AttrESym>}

\newcommand{\GrEdg}[2]{\ensuremath \overrightarrow{#1 #2}}
\newcommand{\GrEdgAB}{\GrEdg{v_1}{v_2}}
\newcommand{\GrEdgBA}{\GrEdg{v_2}{v_1}}
...
\include{Programmer/NonLinearOptim}
...
\include{Programmer/Interpolators}
...
\include{Programmer/Clinometers}

\include{Programmer/Graph}
\COM
{
...
\begin{thebibliography}{AAA}
   ...
   \bibitem[EpipolarGen]{MPD-ER-EPIP-2021}    Marc Pierrot Deseilligny, Ewelina Rupnik. 
