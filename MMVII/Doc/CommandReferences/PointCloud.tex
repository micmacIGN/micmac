...
\section{Generating training data sets for epipolar with {CloudMMVII\_GT\_EpipOrthoC}}
...
\section{Generating training data sets for multi view with {CloudMMVII\_GT\_MultiView}}
