...
Not the fiedl {\tt AdditionalName} that will allow to separate image "043.*" from "671.*" because
they correspond to two different instances of the same camera.
...
(now we can also use image with all target in a plane) :
