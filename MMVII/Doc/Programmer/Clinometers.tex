...
There are two bench :
\begin{itemize}
    \item the first one checks the values computed by Formulas$\_$ClinoBloc.
    \item the other checks that the clinometers calibration with two clinometers and three acquisitions.
\end{itemize}