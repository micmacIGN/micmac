...
At this step, the chapter has no theoretical presentation, it assumes that reader is familliar
...
In our toy example, the schurr complement will be purely artificial. When the
...
The basic mathematical modelization is simply  to consider the images as functions.
