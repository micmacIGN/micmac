...
This part is for the programmer that will need to maintain the core system.
...
The class {\tt cOneLinearConstraint} is used to represent one linear constraint (!! \dots  :-;) .
...
\begin{itemize}
    ...
    \item   "compile" the object , this is apply processing of~\ref{CSTR:NSUBST} to create the
