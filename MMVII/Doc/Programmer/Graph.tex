...
The distinction between oriented and non oriented graph will be done when runing algorithms and their
...
The class {\tt cAlgoCC}, compute the connected component of a graph. It offers $3$ public services :
