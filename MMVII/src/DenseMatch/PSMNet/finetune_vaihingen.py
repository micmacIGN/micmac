...
TrainImgLoader = torch.utils.data.DataLoader(
         DA.myImageFloder(all_left_img,all_right_img,all_left_disp, True, disp_scale=args.disp_scale), 
         batch_size= 12, shuffle= True, num_workers= 6, drop_last=False)

TestImgLoader = torch.utils.data.DataLoader(
         DA.myImageFloder(test_left_img,test_right_img,test_left_disp, False, disp_scale=args.disp_scale), 
