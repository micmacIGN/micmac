...
public:
...

    {
        ...
        else
        {
            ...
            Write(aVecImV2, aRectIm, aRectFile, aDyn, transform);
        }
    }
...
private:
    ...
    void Write(const tvIm& aVecImV2, const cRect2& aRectIm, const cRect2& aRectFile, double aDyn,double * transform=nullptr)
    {
        auto aName      = mDataFile->Name();
