...
namespace MMVII
{
    ...
    class cFormulaClinoRot
    {
        public:
            ...
            {
                // we have :
                // - the first boresight matrix (initial solution : 9 observations) mB1,
                // - the second boresight matrix (initial solution : 9 observations) mB2,
