...
namespace MMVII
{
	...
	std::unique_ptr<cNodeOfTriangles> DefineNewTriangleNode(const tDenseVect &aVecSol, const tIntVect &aIndVec, const int aXInd,
	...
	bool CheckIfConstraintsAreAppliedDuringOptimisation(const int aCurIterNumber,
	...
	bool CheckIfHardConstraintsAreAppliedInCurrentIteration(const bool aHardFreezeForFirstIters, const bool aCurFirstIterWhereHardFreezingUnkIsApplied,
															...
															const bool aHardFreezeForFirstItersUnk)
	{
		const bool aCurIterWithHardFrozenUnknowns = ((aHardFreezeForFirstIters && aCurFirstIterWhereHardFreezingUnkIsApplied) ||
	...
	bool CheckIfSoftConstraintsAreAppliedInCurrentIteration(const bool aSoftFreezeForFirstItersUnk, const bool aCurFirstIterWhereSoftFreezingUnkIsApplied,
	...
	void UnfreezeMultipleUnknowns(const int aSolStart, const int aSolStep,
								  const tIntVect &aVecInd, cResolSysNonLinear<tREAL8> *&aSys)
	{
		for (size_t aIndCurSol = aSolStart; aIndCurSol < aVecInd.size(); aIndCurSol += aSolStep)
		{
	...
	void ApplySoftConstraintToMultipleUnknown(const int aSolStart, const int aSolStep, const tIntVect &aVecInd, cResolSysNonLinear<tREAL8> *&aSys,
										  ...
										  const tDenseVect &aVCurSol, cResolSysNonLinear<tREAL8> *&aSys)
	{
		...
		if (aSoftApplication)
			ApplySoftConstraintToUnknown(aSolStart, aSolStep, aVecInd, aSys, aVCurSol, aWeight);
	}
	*/
