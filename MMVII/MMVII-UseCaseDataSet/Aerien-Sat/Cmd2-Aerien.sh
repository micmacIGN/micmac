...
MMVII  ImportOri  ExternalData/21FD2447_alt.OPK   NXYZWPK  CalibInit  InitL93Up   NumL0=5 ChgN=[".*","\$0.tif"]   "AngU=degree" "KIsUp=true" FilterImIn=ImAerien.xml SysCo=Lambert93
