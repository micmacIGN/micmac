...
VerifParRepr::VerifParRepr(vector<string> mListImg, string aDirImages, string aPatImages, string aNameHomol, string aOri, string aHomolOutput)
{
    {
...
int PHO_MI_main(int argc,char ** argv)
{
 ...
 //===========================================================
    ...
    */
    ...
    if (bStrategie == "6")
    {
        VerifParRepr aImgVerif(aSetImages, aDirImages, aPatImages, aNameHomol, aOriInput, aHomolOutput);
        aImgVerif.creatAbre();
        bool disp = 1;
