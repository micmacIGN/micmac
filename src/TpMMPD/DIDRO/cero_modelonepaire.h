...
private:
    ...
    //cImGeo * mPC1,mPC2,mIncid1,mIncid2;
    ...
    std::vector<Pt2dr> mObsGlob; // observation globale pour le modèle d'égalisation radiom à l'échelles globales
    //std::vector<double> mPond; // pour stoquer une valeur de pondération pour chacune des observations des couples radiométriques
    Pt2di mSzTuile;
