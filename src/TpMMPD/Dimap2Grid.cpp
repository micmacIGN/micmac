...
public:
    ...
    {
        //effacement des fichiers relatifs �  la création des grilles ssi le modèle n'est pas affiné
        if (refine == false)
            {
        ...
        //effacement de la grille affinée + grilles GRC et binaire
        remove (nomGrid.c_str());
                       ...
                       std::vector<double> vRefineCoef, bool refine)const
{
    ...
    //Calcul des coefficients de l'affinité pour la transformation inverse
