...
int tiff_info_main(int argc,char ** argv)
{
    ...
    (
        argc,argv,
        LArgMain() 	<< EAMC(Name,"Image", eSAM_IsExistFile) ,
...
/*
       ...
       {
      std::cout << "AAA\n";
          Tiff_File aTF(Name.c_str());
      std::cout << "cBBBB\n";
          std::cout << "NB Im In Tiff " << aTF.nb_im() << "\n";
       }
       */

    Tiff_Im tiff = Tiff_Im::BasicConvStd(Name.c_str());
