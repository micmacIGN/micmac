...
std::string  Mangling( cFitsOneLabel *) {return "4D3C2EFB6E3021A5FF3F";};
...
std::string  Mangling( cFitsParam *) {return "70912B15F77E52C9FC3F";};
...
std::string  Mangling( cXmlAimeParamApprentissage *) {return "DDAFFEDAD78BD7D3FE3F";};
