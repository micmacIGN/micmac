...
*/
	...
	// 9 sins
	// 3 sets of sins with phasse 0, 2*pi/3 and 4*pi/3 at (1) freq 0.0033 (307pix=4.6km) amplitude 0.05, (2) freq 0.00077 (~1300pix~=19.5km), and (3) freq 0.00044 (2266pix~=34km, bounded 30 to 150 km) amplitude 0.2
	...
	real_1d_array bndu = "[0.3,0.0045,6.29, 0.3,0.0045,6.29, 0.3,0.0045,6.29, 0.3,0.0015,6.29, 0.3,0.0015,6.29, 0.3,0.0015,6.29, 0.3,0.0010,6.29, 0.3,0.0005,6.29, 0.3,0.0005,6.29]";
