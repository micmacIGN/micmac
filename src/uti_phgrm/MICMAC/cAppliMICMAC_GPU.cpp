  ...
  for (int aKIm= 1 ; aKIm<mNbIm ; aKIm++)
  {
     ...
     // std::string Im1_to_Epip12_Masq=aNameBareEpip12+"_Masq.tif";
      ...
      (
       ...
       if ((HomXmin==1e9) || (HomYmin==1e9) || (HomXmax==-1e9) || (HomYmax==-1e9))
         {
            continue;
         }
...

{
  ...
  for (int aKIm= 1 ; aKIm<mNbIm ; aKIm++)
  {
      ...
      // calculer les grilles de deformation
      ...
      (
       ...
       std::cout<<"aBoxSecInEpip  => "<<aBoxSecInEpip<<std::endl;
       if ( ((aBoxSecInEpip.P1().x-aBoxSecInEpip.P0().x)<16)
            || ((aBoxSecInEpip.P1().y-aBoxSecInEpip.P0().y)<16)
            )
         {
           continue;
         }
