...
std::string  Mangling_eModeGeomMEC( eModeGeomMEC *p) { return Mangling(p); }
...
std::string  Mangling_eModeCensusCost( eModeCensusCost *p) { return Mangling(p); }
...
std::string  Mangling_eTypeModeleAnalytique( eTypeModeleAnalytique *p) { return Mangling(p); }
...
std::string  Mangling_eModeGeomImage( eModeGeomImage *p) { return Mangling(p); }
...
std::string  Mangling_eOnEmptyImSecApero( eOnEmptyImSecApero *p) { return Mangling(p); }
...
std::string  Mangling_eModeAggregCorr( eModeAggregCorr *p) { return Mangling(p); }
...
std::string  Mangling_eModeDynamiqueCorrel( eModeDynamiqueCorrel *p) { return Mangling(p); }
...
std::string  Mangling_eTypeImPyram( eTypeImPyram *p) { return Mangling(p); }
...
std::string  Mangling_eAlgoRegul( eAlgoRegul *p) { return Mangling(p); }
...
std::string  Mangling_eModeInterpolation( eModeInterpolation *p) { return Mangling(p); }
...
std::string  Mangling_eTypeFiltrage( eTypeFiltrage *p) { return Mangling(p); }
...
std::string  Mangling_ePxApply( ePxApply *p) { return Mangling(p); }
...
std::string  Mangling_eModeAggregProgDyn( eModeAggregProgDyn *p) { return Mangling(p); }
...
std::string  Mangling_eMicMacCodeRetourErreur( eMicMacCodeRetourErreur *p) { return Mangling(p); }
...
std::string  Mangling_eTypeWinCorrel( eTypeWinCorrel *p) { return Mangling(p); }
...
std::string  Mangling_eTypeModeEchantPtsI( eTypeModeEchantPtsI *p) { return Mangling(p); }
...
std::string  Mangling_eSemantiqueLL( eSemantiqueLL *p) { return Mangling(p); }
