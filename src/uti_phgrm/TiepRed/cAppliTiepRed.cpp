  ...
  mMinNumHomol(20)
{
    ...
    LArgMain()  << EAM(mNumCellsX,"NumPointsX",true,"Target number of tie-points between 2 images in x axis of image space, def=12")
                ...
                << EAM(mMinNumHomol,"MinNumHomol",true,"Minimum number of tie-points for an image pair to be considered. Image pairs with lesser number of tie-points are ignored, def=20")
