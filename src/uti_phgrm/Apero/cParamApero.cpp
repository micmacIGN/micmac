...
std::string  Mangling( cPoseCameraInc *) {return "4A9A6411357EC3CCFF3F";};
...
std::string  Mangling( cSectionInconnues *) {return "7CF1FD7469307BD5FDBF";};
...
std::string  Mangling( cSectionObservations *) {return "7C704FA505EE3E80FF3F";};
