...
std::string  Mangling( cEtapeCompensation *) {return "2CA577C642C62EB6FE3F";};
...
std::string  Mangling( cSectionCompensation *) {return "3283B3E2ADBEC0E6FD3F";};
...
std::string  Mangling( cParamApero *) {return "23F0DBB77BE59EE9FD3F";};
