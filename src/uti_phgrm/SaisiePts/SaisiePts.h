...
public :
    ...
    void            SetInvisRef(bool aVal);                     // a verifier: sert � rendre les points refut�s invisibles ou visibles ?
    bool            RefInvis() const    { return mRefInvis; }

    void            drawZoom(const Pt2dr & aPGlob); //fenetre zoom //peut-�tre � mettre en virtuel ?
