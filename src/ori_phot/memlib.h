...
typedef struct {
	...
	char  dscb_dtype ;
	char  dscb_class ;
	long  dsca_pointeur ; } descr_ ;

/*void * malloc$ ( unsigned int size ) ;*/
/*void free$ ( void *pointeur ) ;*/
void * descr ( char *string, int ll, descr_ *dd ) ;
int fnamlen ( char *nom ) ;
void endstring ( char *nom, int siz ) ;
void libmovc3 ( int *taille, void *source, void *but ) ;
void memomv ( unsigned int size, void *source , void *but ) ;
