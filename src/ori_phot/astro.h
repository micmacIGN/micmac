...
double 	ASTempsSideralMoyen ( double /*JourJulienZeroHeure*/, 
							  double /*TempsUniverselEnHeures*/, 
							  double /*LongitudeOuestEnHeures*/) ;
void	ASAlphaDeltaToAzHt(	double /*TempsSideralMoyenEnRadians*/, 
...
/*
	Calcul de Planetes 
*/
void 	ASAlphaDeltaSoleil( double /*JourJulien*/, 
