...
cTplValGesInit< bool > & cOrientationConique::ZoneUtilInPixel()
{
   return mZoneUtilInPixel;
}

const cTplValGesInit< bool > & cOrientationConique::ZoneUtilInPixel()const 
{
   return mZoneUtilInPixel;
}
...
void  BinaryUnDumpFromFile(cOrientationConique & anObj,ELISE_fp & aFp)
{
  ...
  { bool IsInit;
       BinaryUnDumpFromFile(IsInit,aFp);
        if (IsInit) {
             anObj.ZoneUtilInPixel().SetInitForUnUmp();
             BinaryUnDumpFromFile(anObj.ZoneUtilInPixel().ValForcedForUnUmp(),aFp);
        }
        else  anObj.ZoneUtilInPixel().SetNoInit();
  } ;
  { bool IsInit;
       BinaryUnDumpFromFile(IsInit,aFp);
        if (IsInit) {
...
void  BinaryDumpInFile(ELISE_fp & aFp,const cOrientationConique & anObj)
{
    ...
    BinaryDumpInFile(aFp,anObj.ZoneUtilInPixel().IsInit());
    if (anObj.ZoneUtilInPixel().IsInit()) BinaryDumpInFile(aFp,anObj.ZoneUtilInPixel().Val());
...
cElXMLTree * ToXMLTree(const cOrientationConique & anObj)
{
  ...
  cElXMLTree * aRes = new cElXMLTree((cElXMLTree *)0,"OrientationConique",eXMLBranche);
   ...
   if (anObj.ZoneUtilInPixel().IsInit())
      aRes->AddFils(::ToXMLTree(std::string("ZoneUtilInPixel"),anObj.ZoneUtilInPixel().Val())->ReTagThis("ZoneUtilInPixel"));
...
void xml_init(cOrientationConique & anObj,cElXMLTree * aTree)
{
   ...
   xml_init(anObj.ZoneUtilInPixel(),aTree->Get("ZoneUtilInPixel",1),bool(false)); //tototo 
...
std::string  Mangling( cOrientationConique *) {return "F2184C5D71D32FD5FD3F";};
