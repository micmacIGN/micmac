...
std::string  Mangling_eTypeGpsMod( eTypeGpsMod *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsSolFormat( eTypeGpsSolFormat *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsHeight( eTypeGpsHeight *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGeoid( eTypeGeoid *p) { return Mangling(p); }
...
std::string  Mangling_eTypeRtkOutStats( eTypeRtkOutStats *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsStaticSol( eTypeGpsStaticSol *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsTimeSys( eTypeGpsTimeSys *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsTimeFormat( eTypeGpsTimeFormat *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsDegFormat( eTypeGpsDegFormat *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsFreq( eTypeGpsFreq *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsSol( eTypeGpsSol *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsEphe( eTypeGpsEphe *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsAmbRes( eTypeGpsAmbRes *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGloAmbRes( eTypeGloAmbRes *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsIonoCorr( eTypeGpsIonoCorr *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsTropoCorr( eTypeGpsTropoCorr *p) { return Mangling(p); }
...
std::string  Mangling_eTypeGpsAntPos( eTypeGpsAntPos *p) { return Mangling(p); }
...
std::string  Mangling_eNewTypeMalt( eNewTypeMalt *p) { return Mangling(p); }
...
std::string  Mangling_eTypeTapas( eTypeTapas *p) { return Mangling(p); }
...
std::string  Mangling_eTypeOriVid( eTypeOriVid *p) { return Mangling(p); }
...
std::string  Mangling_eTypeMMByP( eTypeMMByP *p) { return Mangling(p); }
...
std::string  Mangling_eTypeQuality( eTypeQuality *p) { return Mangling(p); }
...
std::string  Mangling_eTypeMalt( eTypeMalt *p) { return Mangling(p); }
...
std::string  Mangling_eTypeFichierApp( eTypeFichierApp *p) { return Mangling(p); }
...
std::string  Mangling_eTypeFichierOriTxt( eTypeFichierOriTxt *p) { return Mangling(p); }
...
std::string  Mangling_eImpaintMethod( eImpaintMethod *p) { return Mangling(p); }
...
std::string  Mangling_eTypeNumerique( eTypeNumerique *p) { return Mangling(p); }
...
std::string  Mangling_eComprTiff( eComprTiff *p) { return Mangling(p); }
...
std::string  Mangling_eTypePreCondRad( eTypePreCondRad *p) { return Mangling(p); }
...
std::string  Mangling_eTypeSake( eTypeSake *p) { return Mangling(p); }
...
std::string  Mangling_eModeGeomMNT( eModeGeomMNT *p) { return Mangling(p); }
...
std::string  Mangling_eModeBinSift( eModeBinSift *p) { return Mangling(p); }
...
std::string  Mangling_eModeSolveurEq( eModeSolveurEq *p) { return Mangling(p); }
...
std::string  Mangling_eUniteAngulaire( eUniteAngulaire *p) { return Mangling(p); }
...
std::string  Mangling_eDegreLiberteCPP( eDegreLiberteCPP *p) { return Mangling(p); }
...
std::string  Mangling_eModelesCalibUnif( eModelesCalibUnif *p) { return Mangling(p); }
...
std::string  Mangling_eTypeProjectionCam( eTypeProjectionCam *p) { return Mangling(p); }
...
std::string  Mangling_eTypeCoord( eTypeCoord *p) { return Mangling(p); }
...
std::string  Mangling_eTotoModeGeomMEC( eTotoModeGeomMEC *p) { return Mangling(p); }
...
std::string  Mangling_eConventionsOrientation( eConventionsOrientation *p) { return Mangling(p); }
...
std::string  Mangling_eExportOri( eExportOri *p) { return Mangling(p); }
...
std::string  Mangling_eTypeDynVino( eTypeDynVino *p) { return Mangling(p); }
...
std::string  Mangling_eCmdMM_Feature( eCmdMM_Feature *p) { return Mangling(p); }
...
std::string  Mangling_eCmdMM_DataType( eCmdMM_DataType *p) { return Mangling(p); }
...
std::string  Mangling_eCmdMM_Group( eCmdMM_Group *p) { return Mangling(p); }
