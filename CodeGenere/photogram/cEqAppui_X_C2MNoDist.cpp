...
#include "cEqAppui_X_C2MNoDist.h"


cEqAppui_X_C2MNoDist::cEqAppui_X_C2MNoDist():
    cElCompiledFonc(1)
{
...
void cEqAppui_X_C2MNoDist::ComputeVal()
{
...
void cEqAppui_X_C2MNoDist::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[3];
   double tmp1_ = mCompCoord[4];
   double tmp2_ = cos(tmp1_);
...
void cEqAppui_X_C2MNoDist::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_X_C2MNoDist Has no Der Sec");
}

void cEqAppui_X_C2MNoDist::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_X_C2MNoDist::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppui_X_C2MNoDist::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppui_X_C2MNoDist::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppui_X_C2MNoDist::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_X_C2MNoDist::mTheAuto("cEqAppui_X_C2MNoDist",cEqAppui_X_C2MNoDist::Alloc);


cElCompiledFonc *  cEqAppui_X_C2MNoDist::Alloc()
{  return new cEqAppui_X_C2MNoDist();
}
