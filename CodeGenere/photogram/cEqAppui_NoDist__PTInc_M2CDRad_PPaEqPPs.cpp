...
#include "cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs.h"


cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::ComputeVal()
{
...
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[8];
   double tmp1_ = mCompCoord[9];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][6] = 0;
  mCompDer[0][7] = 0;
  mCompDer[0][8] = ((tmp105_)*mLocNDdx_x+(tmp117_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][9] = ((tmp128_)*mLocNDdx_x+(tmp140_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][10] = ((tmp143_)*mLocNDdx_x+(tmp159_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][11] = ((tmp164_)*mLocNDdx_x+(tmp169_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][12] = ((tmp174_)*mLocNDdx_x+(tmp179_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][13] = ((tmp183_)*mLocNDdx_x+(tmp188_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][14] = ((tmp192_)*mLocNDdx_x+(tmp196_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][15] = ((tmp200_)*mLocNDdx_x+(tmp204_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp208_)*mLocNDdx_x+(tmp212_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][6] = 0;
  mCompDer[1][7] = 0;
  mCompDer[1][8] = ((tmp105_)*mLocNDdx_y+(tmp117_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][9] = ((tmp128_)*mLocNDdx_y+(tmp140_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][10] = ((tmp143_)*mLocNDdx_y+(tmp159_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][11] = ((tmp164_)*mLocNDdx_y+(tmp169_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][12] = ((tmp174_)*mLocNDdx_y+(tmp179_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][13] = ((tmp183_)*mLocNDdx_y+(tmp188_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][14] = ((tmp192_)*mLocNDdx_y+(tmp196_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][15] = ((tmp200_)*mLocNDdx_y+(tmp204_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp208_)*mLocNDdx_y+(tmp212_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs Has no Der Sec");
}

void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::mTheAuto("cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs",cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs::Alloc()
{  return new cEqAppui_NoDist__PTInc_M2CDRad_PPaEqPPs();
}
