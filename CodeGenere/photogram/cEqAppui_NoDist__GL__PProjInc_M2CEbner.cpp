...
#include "StdAfx.h"
#include "cEqAppui_NoDist__GL__PProjInc_M2CEbner.h"


cEqAppui_NoDist__GL__PProjInc_M2CEbner::cEqAppui_NoDist__GL__PProjInc_M2CEbner():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[15];
   double tmp1_ = mCompCoord[16];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][13] = 0;
  mCompDer[0][14] = 0;
  mCompDer[0][15] = ((tmp252_)*mLocNDdx_x+(tmp270_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp294_)*mLocNDdx_x+(tmp318_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][17] = ((tmp321_)*mLocNDdx_x+(tmp345_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][18] = ((tmp350_)*mLocNDdx_x+(tmp355_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][19] = ((tmp360_)*mLocNDdx_x+(tmp365_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][20] = ((tmp370_)*mLocNDdx_x+(tmp375_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][21] = ((tmp384_)*mLocNDdx_x+(tmp393_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][22] = ((tmp402_)*mLocNDdx_x+(tmp411_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][23] = ((tmp420_)*mLocNDdx_x+(tmp429_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][13] = 0;
  mCompDer[1][14] = 0;
  mCompDer[1][15] = ((tmp252_)*mLocNDdx_y+(tmp270_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp294_)*mLocNDdx_y+(tmp318_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][17] = ((tmp321_)*mLocNDdx_y+(tmp345_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][18] = ((tmp350_)*mLocNDdx_y+(tmp355_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][19] = ((tmp360_)*mLocNDdx_y+(tmp365_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][20] = ((tmp370_)*mLocNDdx_y+(tmp375_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][21] = ((tmp384_)*mLocNDdx_y+(tmp393_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][22] = ((tmp402_)*mLocNDdx_y+(tmp411_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][23] = ((tmp420_)*mLocNDdx_y+(tmp429_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__GL__PProjInc_M2CEbner::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PProjInc_M2CEbner Has no Der Sec");
}

void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PProjInc_M2CEbner::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PProjInc_M2CEbner::mTheAuto("cEqAppui_NoDist__GL__PProjInc_M2CEbner",cEqAppui_NoDist__GL__PProjInc_M2CEbner::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PProjInc_M2CEbner::Alloc()
{  return new cEqAppui_NoDist__GL__PProjInc_M2CEbner();
}
