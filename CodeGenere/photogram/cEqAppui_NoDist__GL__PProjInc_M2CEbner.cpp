...
void cEqAppui_NoDist__GL__PProjInc_M2CEbner::ComputeValDeriv()
{
  ...
  mCompDer[0][13] = 0;
  mCompDer[0][14] = 0;
  mCompDer[0][15] = (tmp259_)*mLocNDdx_x+(tmp277_)*mLocNDdy_x;
  mCompDer[0][16] = (tmp301_)*mLocNDdx_x+(tmp325_)*mLocNDdy_x;
  mCompDer[0][17] = (tmp328_)*mLocNDdx_x+(tmp352_)*mLocNDdy_x;
  mCompDer[0][18] = (tmp357_)*mLocNDdx_x+(tmp362_)*mLocNDdy_x;
  mCompDer[0][19] = (tmp367_)*mLocNDdx_x+(tmp372_)*mLocNDdy_x;
  mCompDer[0][20] = (tmp377_)*mLocNDdx_x+(tmp382_)*mLocNDdy_x;
  mCompDer[0][21] = (tmp391_)*mLocNDdx_x+(tmp400_)*mLocNDdy_x;
  mCompDer[0][22] = (tmp409_)*mLocNDdx_x+(tmp418_)*mLocNDdy_x;
  mCompDer[0][23] = (tmp427_)*mLocNDdx_x+(tmp436_)*mLocNDdy_x;
  ...
  mCompDer[1][13] = 0;
  mCompDer[1][14] = 0;
  mCompDer[1][15] = (tmp259_)*mLocNDdx_y+(tmp277_)*mLocNDdy_y;
  mCompDer[1][16] = (tmp301_)*mLocNDdx_y+(tmp325_)*mLocNDdy_y;
  mCompDer[1][17] = (tmp328_)*mLocNDdx_y+(tmp352_)*mLocNDdy_y;
  mCompDer[1][18] = (tmp357_)*mLocNDdx_y+(tmp362_)*mLocNDdy_y;
  mCompDer[1][19] = (tmp367_)*mLocNDdx_y+(tmp372_)*mLocNDdy_y;
  mCompDer[1][20] = (tmp377_)*mLocNDdx_y+(tmp382_)*mLocNDdy_y;
  mCompDer[1][21] = (tmp391_)*mLocNDdx_y+(tmp400_)*mLocNDdy_y;
  mCompDer[1][22] = (tmp409_)*mLocNDdx_y+(tmp418_)*mLocNDdy_y;
  mCompDer[1][23] = (tmp427_)*mLocNDdx_y+(tmp436_)*mLocNDdy_y;
}
