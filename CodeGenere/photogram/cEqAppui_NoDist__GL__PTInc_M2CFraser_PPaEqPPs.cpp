...
#include "cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs.h"


cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[12];
   double tmp1_ = mCompCoord[13];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][10] = 0;
  mCompDer[0][11] = 0;
  mCompDer[0][12] = ((tmp219_)*mLocNDdx_x+(tmp237_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][13] = ((tmp261_)*mLocNDdx_x+(tmp285_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][14] = ((tmp288_)*mLocNDdx_x+(tmp312_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][15] = ((tmp317_)*mLocNDdx_x+(tmp322_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp327_)*mLocNDdx_x+(tmp332_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][17] = ((tmp337_)*mLocNDdx_x+(tmp342_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][18] = ((tmp346_)*mLocNDdx_x+(tmp350_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][19] = ((tmp354_)*mLocNDdx_x+(tmp358_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][20] = ((tmp362_)*mLocNDdx_x+(tmp366_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][10] = 0;
  mCompDer[1][11] = 0;
  mCompDer[1][12] = ((tmp219_)*mLocNDdx_y+(tmp237_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][13] = ((tmp261_)*mLocNDdx_y+(tmp285_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][14] = ((tmp288_)*mLocNDdx_y+(tmp312_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][15] = ((tmp317_)*mLocNDdx_y+(tmp322_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp327_)*mLocNDdx_y+(tmp332_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][17] = ((tmp337_)*mLocNDdx_y+(tmp342_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][18] = ((tmp346_)*mLocNDdx_y+(tmp350_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][19] = ((tmp354_)*mLocNDdx_y+(tmp358_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][20] = ((tmp362_)*mLocNDdx_y+(tmp366_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs",cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CFraser_PPaEqPPs();
}
