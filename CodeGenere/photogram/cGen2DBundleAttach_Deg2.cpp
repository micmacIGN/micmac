...
void cGen2DBundleAttach_Deg2::SetAmpl(double aVal){ mLocAmpl = aVal;}
void cGen2DBundleAttach_Deg2::SetCentr_x(double aVal){ mLocCentr_x = aVal;}
void cGen2DBundleAttach_Deg2::SetCentr_y(double aVal){ mLocCentr_y = aVal;}
