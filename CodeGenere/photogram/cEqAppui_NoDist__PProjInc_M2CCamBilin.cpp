...
#include "StdAfx.h"
#include "cEqAppui_NoDist__PProjInc_M2CCamBilin.h"


cEqAppui_NoDist__PProjInc_M2CCamBilin::cEqAppui_NoDist__PProjInc_M2CCamBilin():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PProjInc_M2CCamBilin::ComputeVal()
{
...
void cEqAppui_NoDist__PProjInc_M2CCamBilin::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[11];
   double tmp1_ = mCompCoord[12];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][9] = 0;
  mCompDer[0][10] = 0;
  mCompDer[0][11] = ((tmp138_)*mLocNDdx_x+(tmp150_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][12] = ((tmp161_)*mLocNDdx_x+(tmp173_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][13] = ((tmp176_)*mLocNDdx_x+(tmp192_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][14] = ((tmp197_)*mLocNDdx_x+(tmp202_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][15] = ((tmp207_)*mLocNDdx_x+(tmp212_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp216_)*mLocNDdx_x+(tmp221_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][17] = ((tmp230_)*mLocNDdx_x+(tmp239_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][18] = ((tmp248_)*mLocNDdx_x+(tmp257_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][19] = ((tmp266_)*mLocNDdx_x+(tmp275_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][9] = 0;
  mCompDer[1][10] = 0;
  mCompDer[1][11] = ((tmp138_)*mLocNDdx_y+(tmp150_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][12] = ((tmp161_)*mLocNDdx_y+(tmp173_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][13] = ((tmp176_)*mLocNDdx_y+(tmp192_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][14] = ((tmp197_)*mLocNDdx_y+(tmp202_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][15] = ((tmp207_)*mLocNDdx_y+(tmp212_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp216_)*mLocNDdx_y+(tmp221_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][17] = ((tmp230_)*mLocNDdx_y+(tmp239_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][18] = ((tmp248_)*mLocNDdx_y+(tmp257_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][19] = ((tmp266_)*mLocNDdx_y+(tmp275_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__PProjInc_M2CCamBilin::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PProjInc_M2CCamBilin Has no Der Sec");
}

void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CCamBilin::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PProjInc_M2CCamBilin::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PProjInc_M2CCamBilin::mTheAuto("cEqAppui_NoDist__PProjInc_M2CCamBilin",cEqAppui_NoDist__PProjInc_M2CCamBilin::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PProjInc_M2CCamBilin::Alloc()
{  return new cEqAppui_NoDist__PProjInc_M2CCamBilin();
}
