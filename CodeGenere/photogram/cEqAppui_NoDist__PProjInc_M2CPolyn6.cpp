...
#include "cEqAppui_NoDist__PProjInc_M2CPolyn6.h"


cEqAppui_NoDist__PProjInc_M2CPolyn6::cEqAppui_NoDist__PProjInc_M2CPolyn6():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PProjInc_M2CPolyn6::ComputeVal()
{
...
void cEqAppui_NoDist__PProjInc_M2CPolyn6::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[53];
   double tmp1_ = mCompCoord[54];
   double tmp2_ = cos(tmp1_);
...
void cEqAppui_NoDist__PProjInc_M2CPolyn6::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PProjInc_M2CPolyn6 Has no Der Sec");
}

void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn6::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PProjInc_M2CPolyn6::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PProjInc_M2CPolyn6::mTheAuto("cEqAppui_NoDist__PProjInc_M2CPolyn6",cEqAppui_NoDist__PProjInc_M2CPolyn6::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PProjInc_M2CPolyn6::Alloc()
{  return new cEqAppui_NoDist__PProjInc_M2CPolyn6();
}
