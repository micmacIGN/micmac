...
#include "cEqAppui_NoDist__GL__PTInc_M2CPolyn7.h"


cEqAppui_NoDist__GL__PTInc_M2CPolyn7::cEqAppui_NoDist__GL__PTInc_M2CPolyn7():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[69];
   double tmp1_ = mCompCoord[70];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][67] = 0;
  mCompDer[0][68] = 0;
  mCompDer[0][69] = (tmp219_)*mLocNDdx_x+(tmp237_)*mLocNDdy_x;
  mCompDer[0][70] = (tmp261_)*mLocNDdx_x+(tmp285_)*mLocNDdy_x;
  mCompDer[0][71] = (tmp288_)*mLocNDdx_x+(tmp312_)*mLocNDdy_x;
  mCompDer[0][72] = (tmp317_)*mLocNDdx_x+(tmp322_)*mLocNDdy_x;
  mCompDer[0][73] = (tmp327_)*mLocNDdx_x+(tmp332_)*mLocNDdy_x;
  mCompDer[0][74] = (tmp337_)*mLocNDdx_x+(tmp342_)*mLocNDdy_x;
  mCompDer[0][75] = (tmp346_)*mLocNDdx_x+(tmp350_)*mLocNDdy_x;
  mCompDer[0][76] = (tmp354_)*mLocNDdx_x+(tmp358_)*mLocNDdy_x;
  mCompDer[0][77] = (tmp362_)*mLocNDdx_x+(tmp366_)*mLocNDdy_x;
  ...
  mCompDer[1][67] = 0;
  mCompDer[1][68] = 0;
  mCompDer[1][69] = (tmp219_)*mLocNDdx_y+(tmp237_)*mLocNDdy_y;
  mCompDer[1][70] = (tmp261_)*mLocNDdx_y+(tmp285_)*mLocNDdy_y;
  mCompDer[1][71] = (tmp288_)*mLocNDdx_y+(tmp312_)*mLocNDdy_y;
  mCompDer[1][72] = (tmp317_)*mLocNDdx_y+(tmp322_)*mLocNDdy_y;
  mCompDer[1][73] = (tmp327_)*mLocNDdx_y+(tmp332_)*mLocNDdy_y;
  mCompDer[1][74] = (tmp337_)*mLocNDdx_y+(tmp342_)*mLocNDdy_y;
  mCompDer[1][75] = (tmp346_)*mLocNDdx_y+(tmp350_)*mLocNDdy_y;
  mCompDer[1][76] = (tmp354_)*mLocNDdx_y+(tmp358_)*mLocNDdy_y;
  mCompDer[1][77] = (tmp362_)*mLocNDdx_y+(tmp366_)*mLocNDdy_y;
}


void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CPolyn7 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn7::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CPolyn7::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CPolyn7::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CPolyn7",cEqAppui_NoDist__GL__PTInc_M2CPolyn7::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CPolyn7::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CPolyn7();
}
