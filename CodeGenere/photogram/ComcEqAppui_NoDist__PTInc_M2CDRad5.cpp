...
void cEqAppui_NoDist__PTInc_M2CDRad5::ComputeVal()
{
   ...
   double tmp7_ = mCompCoord[16];  // X Ter
   double tmp8_ = mCompCoord[13];  //  X Cam
   double tmp9_ = tmp7_-tmp8_;     // CT.x
   double tmp10_ = sin(tmp6_);
   double tmp11_ = -(tmp10_);
   double tmp12_ = -(tmp5_);
   double tmp13_ = cos(tmp6_);
   double tmp14_ = mCompCoord[17];  // Y Ter
   double tmp15_ = mCompCoord[14];  // Y Cam
   double tmp16_ = tmp14_-tmp15_;   // CT.y
   double tmp17_ = mCompCoord[18];  // Z Ter
   double tmp18_ = mCompCoord[15];  // Z Cam
   double tmp19_ = tmp17_-tmp18_;   // CT.z
   double tmp20_ = -(tmp3_);
   ...
   double tmp54_ = tmp51_+tmp53_;  // Y Cam
