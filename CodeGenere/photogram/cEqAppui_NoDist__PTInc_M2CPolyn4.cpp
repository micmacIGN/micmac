...
#include "cEqAppui_NoDist__PTInc_M2CPolyn4.h"


cEqAppui_NoDist__PTInc_M2CPolyn4::cEqAppui_NoDist__PTInc_M2CPolyn4():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PTInc_M2CPolyn4::ComputeVal()
{
...
void cEqAppui_NoDist__PTInc_M2CPolyn4::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[27];
   double tmp1_ = mCompCoord[28];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][25] = 0;
  mCompDer[0][26] = 0;
  mCompDer[0][27] = (tmp105_)*mLocNDdx_x+(tmp117_)*mLocNDdy_x;
  mCompDer[0][28] = (tmp128_)*mLocNDdx_x+(tmp140_)*mLocNDdy_x;
  mCompDer[0][29] = (tmp143_)*mLocNDdx_x+(tmp159_)*mLocNDdy_x;
  mCompDer[0][30] = (tmp164_)*mLocNDdx_x+(tmp169_)*mLocNDdy_x;
  mCompDer[0][31] = (tmp174_)*mLocNDdx_x+(tmp179_)*mLocNDdy_x;
  mCompDer[0][32] = (tmp183_)*mLocNDdx_x+(tmp188_)*mLocNDdy_x;
  mCompDer[0][33] = (tmp192_)*mLocNDdx_x+(tmp196_)*mLocNDdy_x;
  mCompDer[0][34] = (tmp200_)*mLocNDdx_x+(tmp204_)*mLocNDdy_x;
  mCompDer[0][35] = (tmp208_)*mLocNDdx_x+(tmp212_)*mLocNDdy_x;
  ...
  mCompDer[1][25] = 0;
  mCompDer[1][26] = 0;
  mCompDer[1][27] = (tmp105_)*mLocNDdx_y+(tmp117_)*mLocNDdy_y;
  mCompDer[1][28] = (tmp128_)*mLocNDdx_y+(tmp140_)*mLocNDdy_y;
  mCompDer[1][29] = (tmp143_)*mLocNDdx_y+(tmp159_)*mLocNDdy_y;
  mCompDer[1][30] = (tmp164_)*mLocNDdx_y+(tmp169_)*mLocNDdy_y;
  mCompDer[1][31] = (tmp174_)*mLocNDdx_y+(tmp179_)*mLocNDdy_y;
  mCompDer[1][32] = (tmp183_)*mLocNDdx_y+(tmp188_)*mLocNDdy_y;
  mCompDer[1][33] = (tmp192_)*mLocNDdx_y+(tmp196_)*mLocNDdy_y;
  mCompDer[1][34] = (tmp200_)*mLocNDdx_y+(tmp204_)*mLocNDdy_y;
  mCompDer[1][35] = (tmp208_)*mLocNDdx_y+(tmp212_)*mLocNDdy_y;
}


void cEqAppui_NoDist__PTInc_M2CPolyn4::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PTInc_M2CPolyn4 Has no Der Sec");
}

void cEqAppui_NoDist__PTInc_M2CPolyn4::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn4::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn4::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn4::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn4::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn4::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn4::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn4::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PTInc_M2CPolyn4::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PTInc_M2CPolyn4::mTheAuto("cEqAppui_NoDist__PTInc_M2CPolyn4",cEqAppui_NoDist__PTInc_M2CPolyn4::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PTInc_M2CPolyn4::Alloc()
{  return new cEqAppui_NoDist__PTInc_M2CPolyn4();
}
