...
#include "StdAfx.h"
#include "cEqAppui_NoDist__GL__PProjInc_M2CFour11x2.h"


cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::cEqAppui_NoDist__GL__PProjInc_M2CFour11x2():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[16];
   double tmp1_ = mCompCoord[17];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][14] = 0;
  mCompDer[0][15] = 0;
  mCompDer[0][16] = ((tmp252_)*mLocNDdx_x+(tmp270_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][17] = ((tmp294_)*mLocNDdx_x+(tmp318_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][18] = ((tmp321_)*mLocNDdx_x+(tmp345_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][19] = ((tmp350_)*mLocNDdx_x+(tmp355_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][20] = ((tmp360_)*mLocNDdx_x+(tmp365_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][21] = ((tmp370_)*mLocNDdx_x+(tmp375_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][22] = ((tmp384_)*mLocNDdx_x+(tmp393_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][23] = ((tmp402_)*mLocNDdx_x+(tmp411_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][24] = ((tmp420_)*mLocNDdx_x+(tmp429_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][14] = 0;
  mCompDer[1][15] = 0;
  mCompDer[1][16] = ((tmp252_)*mLocNDdx_y+(tmp270_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][17] = ((tmp294_)*mLocNDdx_y+(tmp318_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][18] = ((tmp321_)*mLocNDdx_y+(tmp345_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][19] = ((tmp350_)*mLocNDdx_y+(tmp355_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][20] = ((tmp360_)*mLocNDdx_y+(tmp365_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][21] = ((tmp370_)*mLocNDdx_y+(tmp375_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][22] = ((tmp384_)*mLocNDdx_y+(tmp393_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][23] = ((tmp402_)*mLocNDdx_y+(tmp411_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][24] = ((tmp420_)*mLocNDdx_y+(tmp429_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PProjInc_M2CFour11x2 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::mTheAuto("cEqAppui_NoDist__GL__PProjInc_M2CFour11x2",cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PProjInc_M2CFour11x2::Alloc()
{  return new cEqAppui_NoDist__GL__PProjInc_M2CFour11x2();
}
