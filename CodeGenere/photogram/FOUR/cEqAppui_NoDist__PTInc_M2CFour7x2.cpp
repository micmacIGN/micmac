...
#include "StdAfx.h"
#include "cEqAppui_NoDist__PTInc_M2CFour7x2.h"


cEqAppui_NoDist__PTInc_M2CFour7x2::cEqAppui_NoDist__PTInc_M2CFour7x2():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PTInc_M2CFour7x2::ComputeVal()
{
...
void cEqAppui_NoDist__PTInc_M2CFour7x2::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[14];
   double tmp1_ = mCompCoord[15];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][12] = 0;
  mCompDer[0][13] = 0;
  mCompDer[0][14] = ((tmp105_)*mLocNDdx_x+(tmp117_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][15] = ((tmp128_)*mLocNDdx_x+(tmp140_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp143_)*mLocNDdx_x+(tmp159_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][17] = ((tmp164_)*mLocNDdx_x+(tmp169_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][18] = ((tmp174_)*mLocNDdx_x+(tmp179_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][19] = ((tmp183_)*mLocNDdx_x+(tmp188_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][20] = ((tmp192_)*mLocNDdx_x+(tmp196_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][21] = ((tmp200_)*mLocNDdx_x+(tmp204_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][22] = ((tmp208_)*mLocNDdx_x+(tmp212_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][12] = 0;
  mCompDer[1][13] = 0;
  mCompDer[1][14] = ((tmp105_)*mLocNDdx_y+(tmp117_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][15] = ((tmp128_)*mLocNDdx_y+(tmp140_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp143_)*mLocNDdx_y+(tmp159_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][17] = ((tmp164_)*mLocNDdx_y+(tmp169_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][18] = ((tmp174_)*mLocNDdx_y+(tmp179_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][19] = ((tmp183_)*mLocNDdx_y+(tmp188_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][20] = ((tmp192_)*mLocNDdx_y+(tmp196_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][21] = ((tmp200_)*mLocNDdx_y+(tmp204_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][22] = ((tmp208_)*mLocNDdx_y+(tmp212_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__PTInc_M2CFour7x2::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PTInc_M2CFour7x2 Has no Der Sec");
}

void cEqAppui_NoDist__PTInc_M2CFour7x2::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PTInc_M2CFour7x2::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PTInc_M2CFour7x2::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PTInc_M2CFour7x2::mTheAuto("cEqAppui_NoDist__PTInc_M2CFour7x2",cEqAppui_NoDist__PTInc_M2CFour7x2::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PTInc_M2CFour7x2::Alloc()
{  return new cEqAppui_NoDist__PTInc_M2CFour7x2();
}
