...
#include "StdAfx.h"
#include "cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5.h"


cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::ComputeVal()
{
  ...
  mVal[0] = ((mLocNDP0_x + mLocNDdx_x * (tmp79_) + mLocNDdy_x * (tmp100_)) - mLocXIm) * mLocScNorm;

  mVal[1] = ((mLocNDP0_y + mLocNDdx_y * (tmp79_) + mLocNDdy_y * (tmp100_)) - mLocYIm) * mLocScNorm;

}


void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[53];
   double tmp1_ = mCompCoord[54];
   double tmp2_ = cos(tmp1_);
  ...
  mVal[0] = ((mLocNDP0_x + mLocNDdx_x * (tmp200_) + mLocNDdy_x * (tmp201_)) - mLocXIm) * mLocScNorm;
  ...
  mCompDer[0][51] = 0;
  mCompDer[0][52] = 0;
  mCompDer[0][53] = ((tmp219_) * mLocNDdx_x + (tmp237_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][54] = ((tmp261_) * mLocNDdx_x + (tmp285_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][55] = ((tmp288_) * mLocNDdx_x + (tmp312_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][56] = ((tmp317_) * mLocNDdx_x + (tmp322_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][57] = ((tmp327_) * mLocNDdx_x + (tmp332_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][58] = ((tmp337_) * mLocNDdx_x + (tmp342_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][59] = ((tmp346_) * mLocNDdx_x + (tmp350_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][60] = ((tmp354_) * mLocNDdx_x + (tmp358_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][61] = ((tmp362_) * mLocNDdx_x + (tmp366_) * mLocNDdy_x) * mLocScNorm;
  mVal[1] = ((mLocNDP0_y + mLocNDdx_y * (tmp200_) + mLocNDdy_y * (tmp201_)) - mLocYIm) * mLocScNorm;
  ...
  mCompDer[1][51] = 0;
  mCompDer[1][52] = 0;
  mCompDer[1][53] = ((tmp219_) * mLocNDdx_y + (tmp237_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][54] = ((tmp261_) * mLocNDdx_y + (tmp285_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][55] = ((tmp288_) * mLocNDdx_y + (tmp312_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][56] = ((tmp317_) * mLocNDdx_y + (tmp322_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][57] = ((tmp327_) * mLocNDdx_y + (tmp332_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][58] = ((tmp337_) * mLocNDdx_y + (tmp342_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][59] = ((tmp346_) * mLocNDdx_y + (tmp350_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][60] = ((tmp354_) * mLocNDdx_y + (tmp358_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][61] = ((tmp362_) * mLocNDdx_y + (tmp366_) * mLocNDdy_y) * mLocScNorm;
}


void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5",cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CStereographique_FishEye_10_5_5();
}
