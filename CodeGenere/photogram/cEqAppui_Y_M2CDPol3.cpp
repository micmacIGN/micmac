...
#include "cEqAppui_Y_M2CDPol3.h"


cEqAppui_Y_M2CDPol3::cEqAppui_Y_M2CDPol3():
    cElCompiledFonc(1)
{
...
void cEqAppui_Y_M2CDPol3::ComputeVal()
{
  ...
  mVal[0] = (mCompCoord[10]+mCompCoord[11]*(tmp44_)+mCompCoord[12]*(tmp52_)+mCompCoord[13]*tmp53_+mCompCoord[14]*(tmp52_)*(tmp44_)+mCompCoord[15]*tmp54_+mCompCoord[16]*VCube(tmp44_)+mCompCoord[17]*(tmp52_)*tmp53_+mCompCoord[18]*tmp54_*(tmp44_)+mCompCoord[19]*VCube(tmp52_))-mLocYIm;

}


void cEqAppui_Y_M2CDPol3::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[20];
   double tmp1_ = mCompCoord[22];
   double tmp2_ = cos(tmp0_);
  ...
  mVal[0] = (mCompCoord[10]+tmp61_*(tmp44_)+tmp71_*(tmp52_)+tmp84_*tmp53_+tmp94_*(tmp44_)+tmp95_*tmp54_+tmp96_*tmp55_+tmp100_*tmp53_+tmp104_*(tmp44_)+tmp105_*tmp56_)-mLocYIm;
  ...
  mCompDer[0][9] = 0;
  mCompDer[0][10] = 1;
  mCompDer[0][11] = tmp44_;
  mCompDer[0][12] = tmp52_;
  mCompDer[0][13] = tmp53_;
  mCompDer[0][14] = (tmp52_)*(tmp44_);
  mCompDer[0][15] = tmp54_;
  mCompDer[0][16] = tmp55_;
  mCompDer[0][17] = (tmp52_)*tmp53_;
  mCompDer[0][18] = tmp54_*(tmp44_);
  mCompDer[0][19] = tmp56_;
...
void cEqAppui_Y_M2CDPol3::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_Y_M2CDPol3 Has no Der Sec");
}

void cEqAppui_Y_M2CDPol3::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppui_Y_M2CDPol3::SetYIm(double aVal){ mLocYIm = aVal;}
void cEqAppui_Y_M2CDPol3::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppui_Y_M2CDPol3::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppui_Y_M2CDPol3::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_Y_M2CDPol3::mTheAuto("cEqAppui_Y_M2CDPol3",cEqAppui_Y_M2CDPol3::Alloc);


cElCompiledFonc *  cEqAppui_Y_M2CDPol3::Alloc()
{  return new cEqAppui_Y_M2CDPol3();
}
