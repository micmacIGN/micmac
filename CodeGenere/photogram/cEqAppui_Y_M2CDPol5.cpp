...
#include "cEqAppui_Y_M2CDPol5.h"


cEqAppui_Y_M2CDPol5::cEqAppui_Y_M2CDPol5():
    cElCompiledFonc(1)
{
...
void cEqAppui_Y_M2CDPol5::ComputeVal()
{
  ...
  mVal[0] = (mCompCoord[21]+mCompCoord[22]*(tmp44_)+mCompCoord[23]*(tmp52_)+mCompCoord[24]*tmp53_+mCompCoord[25]*(tmp52_)*(tmp44_)+mCompCoord[26]*tmp54_+mCompCoord[27]*tmp55_+mCompCoord[28]*(tmp52_)*tmp53_+mCompCoord[29]*tmp54_*(tmp44_)+mCompCoord[30]*tmp56_+mCompCoord[31]*tmp57_+mCompCoord[32]*(tmp52_)*tmp55_+mCompCoord[33]*tmp54_*tmp53_+mCompCoord[34]*tmp56_*(tmp44_)+mCompCoord[35]*tmp58_+mCompCoord[36]*VPow5(tmp44_)+mCompCoord[37]*(tmp52_)*tmp57_+mCompCoord[38]*tmp54_*tmp55_+mCompCoord[39]*tmp56_*tmp53_+mCompCoord[40]*tmp58_*(tmp44_)+mCompCoord[41]*VPow5(tmp52_))-mLocYIm;

}


void cEqAppui_Y_M2CDPol5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[42];
   double tmp1_ = mCompCoord[44];
   double tmp2_ = cos(tmp0_);
   ...
   double tmp97_ = mCompCoord[25];
   double tmp98_ = tmp97_*(tmp52_);
   double tmp99_ = mCompCoord[26];
   double tmp100_ = mCompCoord[27];
   double tmp101_ = mCompCoord[28];
  ...
  mCompDer[0][20] = 0;
  mCompDer[0][21] = 1;
  mCompDer[0][22] = tmp44_;
  mCompDer[0][23] = tmp52_;
  mCompDer[0][24] = tmp53_;
  mCompDer[0][25] = (tmp52_)*(tmp44_);
  mCompDer[0][26] = tmp54_;
  mCompDer[0][27] = tmp55_;
  mCompDer[0][28] = (tmp52_)*tmp53_;
  mCompDer[0][29] = tmp54_*(tmp44_);
  mCompDer[0][30] = tmp56_;
  mCompDer[0][31] = tmp57_;
  mCompDer[0][32] = (tmp52_)*tmp55_;
  mCompDer[0][33] = tmp54_*tmp53_;
  mCompDer[0][34] = tmp56_*(tmp44_);
  mCompDer[0][35] = tmp58_;
  mCompDer[0][36] = tmp59_;
  mCompDer[0][37] = (tmp52_)*tmp57_;
  mCompDer[0][38] = tmp54_*tmp55_;
  mCompDer[0][39] = tmp56_*tmp53_;
  mCompDer[0][40] = tmp58_*(tmp44_);
  mCompDer[0][41] = tmp60_;
...
void cEqAppui_Y_M2CDPol5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_Y_M2CDPol5 Has no Der Sec");
}

void cEqAppui_Y_M2CDPol5::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppui_Y_M2CDPol5::SetYIm(double aVal){ mLocYIm = aVal;}
void cEqAppui_Y_M2CDPol5::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppui_Y_M2CDPol5::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppui_Y_M2CDPol5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_Y_M2CDPol5::mTheAuto("cEqAppui_Y_M2CDPol5",cEqAppui_Y_M2CDPol5::Alloc);


cElCompiledFonc *  cEqAppui_Y_M2CDPol5::Alloc()
{  return new cEqAppui_Y_M2CDPol5();
}
