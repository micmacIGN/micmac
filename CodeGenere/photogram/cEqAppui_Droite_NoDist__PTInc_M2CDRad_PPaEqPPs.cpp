...
#include "StdAfx.h"
#include "cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs.h"


cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs():
    cElCompiledFonc(1)
{
...
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::ComputeVal()
{
...
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[8];
   double tmp1_ = mCompCoord[9];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][6] = 0;
  mCompDer[0][7] = 0;
  mCompDer[0][8] = (-(((tmp77_)*mLocNDdx_x+(tmp89_)*mLocNDdy_x)*tmp69_)-((tmp77_)*mLocNDdx_y+(tmp89_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][9] = (-(((tmp113_)*mLocNDdx_x+(tmp125_)*mLocNDdy_x)*tmp69_)-((tmp113_)*mLocNDdx_y+(tmp125_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][10] = (-(((tmp142_)*mLocNDdx_x+(tmp158_)*mLocNDdy_x)*tmp69_)-((tmp142_)*mLocNDdx_y+(tmp158_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][11] = (-(((tmp164_)*mLocNDdx_x+(tmp169_)*mLocNDdy_x)*tmp69_)-((tmp164_)*mLocNDdx_y+(tmp169_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][12] = (-(((tmp175_)*mLocNDdx_x+(tmp180_)*mLocNDdy_x)*tmp69_)-((tmp175_)*mLocNDdx_y+(tmp180_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][13] = (-(((tmp185_)*mLocNDdx_x+(tmp190_)*mLocNDdy_x)*tmp69_)-((tmp185_)*mLocNDdx_y+(tmp190_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][14] = (-(((tmp194_)*mLocNDdx_x+(tmp198_)*mLocNDdy_x)*tmp69_)-((tmp194_)*mLocNDdx_y+(tmp198_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][15] = (-(((tmp202_)*mLocNDdx_x+(tmp206_)*mLocNDdy_x)*tmp69_)-((tmp202_)*mLocNDdx_y+(tmp206_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
  mCompDer[0][16] = (-(((tmp210_)*mLocNDdx_x+(tmp214_)*mLocNDdy_x)*tmp69_)-((tmp210_)*mLocNDdx_y+(tmp214_)*mLocNDdy_y)*tmp90_)*mLocScNorm;
}


void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs Has no Der Sec");
}

void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::mTheAuto("cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs",cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::Alloc);


cElCompiledFonc *  cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs::Alloc()
{  return new cEqAppui_Droite_NoDist__PTInc_M2CDRad_PPaEqPPs();
}
