...
#include "cEqAppui_NoDist__GL__PTInc_M2CDRad5.h"


cEqAppui_NoDist__GL__PTInc_M2CDRad5::cEqAppui_NoDist__GL__PTInc_M2CDRad5():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[10];
   double tmp1_ = mCompCoord[11];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][8] = 0;
  mCompDer[0][9] = 0;
  mCompDer[0][10] = (tmp219_)*mLocNDdx_x+(tmp237_)*mLocNDdy_x;
  mCompDer[0][11] = (tmp261_)*mLocNDdx_x+(tmp285_)*mLocNDdy_x;
  mCompDer[0][12] = (tmp288_)*mLocNDdx_x+(tmp312_)*mLocNDdy_x;
  mCompDer[0][13] = (tmp317_)*mLocNDdx_x+(tmp322_)*mLocNDdy_x;
  mCompDer[0][14] = (tmp327_)*mLocNDdx_x+(tmp332_)*mLocNDdy_x;
  mCompDer[0][15] = (tmp337_)*mLocNDdx_x+(tmp342_)*mLocNDdy_x;
  mCompDer[0][16] = (tmp346_)*mLocNDdx_x+(tmp350_)*mLocNDdy_x;
  mCompDer[0][17] = (tmp354_)*mLocNDdx_x+(tmp358_)*mLocNDdy_x;
  mCompDer[0][18] = (tmp362_)*mLocNDdx_x+(tmp366_)*mLocNDdy_x;
  ...
  mCompDer[1][8] = 0;
  mCompDer[1][9] = 0;
  mCompDer[1][10] = (tmp219_)*mLocNDdx_y+(tmp237_)*mLocNDdy_y;
  mCompDer[1][11] = (tmp261_)*mLocNDdx_y+(tmp285_)*mLocNDdy_y;
  mCompDer[1][12] = (tmp288_)*mLocNDdx_y+(tmp312_)*mLocNDdy_y;
  mCompDer[1][13] = (tmp317_)*mLocNDdx_y+(tmp322_)*mLocNDdy_y;
  mCompDer[1][14] = (tmp327_)*mLocNDdx_y+(tmp332_)*mLocNDdy_y;
  mCompDer[1][15] = (tmp337_)*mLocNDdx_y+(tmp342_)*mLocNDdy_y;
  mCompDer[1][16] = (tmp346_)*mLocNDdx_y+(tmp350_)*mLocNDdy_y;
  mCompDer[1][17] = (tmp354_)*mLocNDdx_y+(tmp358_)*mLocNDdy_y;
  mCompDer[1][18] = (tmp362_)*mLocNDdx_y+(tmp366_)*mLocNDdy_y;
}


void cEqAppui_NoDist__GL__PTInc_M2CDRad5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CDRad5 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad5::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CDRad5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CDRad5::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CDRad5",cEqAppui_NoDist__GL__PTInc_M2CDRad5::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CDRad5::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CDRad5();
}
