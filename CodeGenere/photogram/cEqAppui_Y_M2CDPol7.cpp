...
#include "cEqAppui_Y_M2CDPol7.h"


cEqAppui_Y_M2CDPol7::cEqAppui_Y_M2CDPol7():
    cElCompiledFonc(1)
{
...
void cEqAppui_Y_M2CDPol7::ComputeVal()
{
  ...
  mVal[0] = (mCompCoord[36]+mCompCoord[37]*(tmp44_)+mCompCoord[38]*(tmp52_)+mCompCoord[39]*tmp53_+mCompCoord[40]*(tmp52_)*(tmp44_)+mCompCoord[41]*tmp54_+mCompCoord[42]*tmp55_+mCompCoord[43]*(tmp52_)*tmp53_+mCompCoord[44]*tmp54_*(tmp44_)+mCompCoord[45]*tmp56_+mCompCoord[46]*tmp57_+mCompCoord[47]*(tmp52_)*tmp55_+mCompCoord[48]*tmp54_*tmp53_+mCompCoord[49]*tmp56_*(tmp44_)+mCompCoord[50]*tmp58_+mCompCoord[51]*tmp59_+mCompCoord[52]*(tmp52_)*tmp57_+mCompCoord[53]*tmp54_*tmp55_+mCompCoord[54]*tmp56_*tmp53_+mCompCoord[55]*tmp58_*(tmp44_)+mCompCoord[56]*tmp60_+mCompCoord[57]*tmp61_+mCompCoord[58]*(tmp52_)*tmp59_+mCompCoord[59]*tmp54_*tmp57_+mCompCoord[60]*tmp56_*tmp55_+mCompCoord[61]*tmp58_*tmp53_+mCompCoord[62]*tmp60_*(tmp44_)+mCompCoord[63]*tmp62_+mCompCoord[64]*VPow7(tmp44_)+mCompCoord[65]*(tmp52_)*tmp61_+mCompCoord[66]*tmp54_*tmp59_+mCompCoord[67]*tmp56_*tmp57_+mCompCoord[68]*tmp58_*tmp55_+mCompCoord[69]*tmp60_*tmp53_+mCompCoord[70]*tmp62_*(tmp44_)+mCompCoord[71]*VPow7(tmp52_))-mLocYIm;

}


void cEqAppui_Y_M2CDPol7::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[72];
   double tmp1_ = mCompCoord[74];
   double tmp2_ = cos(tmp0_);
   ...
   double tmp101_ = mCompCoord[40];
   double tmp102_ = tmp101_*(tmp52_);
   double tmp103_ = mCompCoord[41];
   double tmp104_ = mCompCoord[42];
   double tmp105_ = mCompCoord[43];
  ...
  mCompDer[0][35] = 0;
  mCompDer[0][36] = 1;
  mCompDer[0][37] = tmp44_;
  mCompDer[0][38] = tmp52_;
  mCompDer[0][39] = tmp53_;
  mCompDer[0][40] = (tmp52_)*(tmp44_);
  mCompDer[0][41] = tmp54_;
  mCompDer[0][42] = tmp55_;
  mCompDer[0][43] = (tmp52_)*tmp53_;
  mCompDer[0][44] = tmp54_*(tmp44_);
  mCompDer[0][45] = tmp56_;
  mCompDer[0][46] = tmp57_;
  mCompDer[0][47] = (tmp52_)*tmp55_;
  mCompDer[0][48] = tmp54_*tmp53_;
  mCompDer[0][49] = tmp56_*(tmp44_);
  mCompDer[0][50] = tmp58_;
  mCompDer[0][51] = tmp59_;
  mCompDer[0][52] = (tmp52_)*tmp57_;
  mCompDer[0][53] = tmp54_*tmp55_;
  mCompDer[0][54] = tmp56_*tmp53_;
  mCompDer[0][55] = tmp58_*(tmp44_);
  mCompDer[0][56] = tmp60_;
  mCompDer[0][57] = tmp61_;
  mCompDer[0][58] = (tmp52_)*tmp59_;
  mCompDer[0][59] = tmp54_*tmp57_;
  mCompDer[0][60] = tmp56_*tmp55_;
  mCompDer[0][61] = tmp58_*tmp53_;
  mCompDer[0][62] = tmp60_*(tmp44_);
  mCompDer[0][63] = tmp62_;
  mCompDer[0][64] = tmp63_;
  mCompDer[0][65] = (tmp52_)*tmp61_;
  mCompDer[0][66] = tmp54_*tmp59_;
  mCompDer[0][67] = tmp56_*tmp57_;
  mCompDer[0][68] = tmp58_*tmp55_;
  mCompDer[0][69] = tmp60_*tmp53_;
  mCompDer[0][70] = tmp62_*(tmp44_);
  mCompDer[0][71] = tmp64_;
...
void cEqAppui_Y_M2CDPol7::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_Y_M2CDPol7 Has no Der Sec");
}

void cEqAppui_Y_M2CDPol7::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppui_Y_M2CDPol7::SetYIm(double aVal){ mLocYIm = aVal;}
void cEqAppui_Y_M2CDPol7::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppui_Y_M2CDPol7::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppui_Y_M2CDPol7::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_Y_M2CDPol7::mTheAuto("cEqAppui_Y_M2CDPol7",cEqAppui_Y_M2CDPol7::Alloc);


cElCompiledFonc *  cEqAppui_Y_M2CDPol7::Alloc()
{  return new cEqAppui_Y_M2CDPol7();
}
