...
#include "cEqAppui_GL__TerFix_M2CNoDist.h"


cEqAppui_GL__TerFix_M2CNoDist::cEqAppui_GL__TerFix_M2CNoDist():
    cElCompiledFonc(2)
{
...
void cEqAppui_GL__TerFix_M2CNoDist::ComputeVal()
{
...
void cEqAppui_GL__TerFix_M2CNoDist::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[3];
   double tmp1_ = mCompCoord[4];
   double tmp2_ = cos(tmp1_);
...
void cEqAppui_GL__TerFix_M2CNoDist::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_GL__TerFix_M2CNoDist Has no Der Sec");
}

void cEqAppui_GL__TerFix_M2CNoDist::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetYIm(double aVal){ mLocYIm = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppui_GL__TerFix_M2CNoDist::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppui_GL__TerFix_M2CNoDist::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_GL__TerFix_M2CNoDist::mTheAuto("cEqAppui_GL__TerFix_M2CNoDist",cEqAppui_GL__TerFix_M2CNoDist::Alloc);


cElCompiledFonc *  cEqAppui_GL__TerFix_M2CNoDist::Alloc()
{  return new cEqAppui_GL__TerFix_M2CNoDist();
}
