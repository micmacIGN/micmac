...
#include "cEqAppui_NoDist__PProjInc_M2CNoDist.h"


cEqAppui_NoDist__PProjInc_M2CNoDist::cEqAppui_NoDist__PProjInc_M2CNoDist():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PProjInc_M2CNoDist::ComputeVal()
{
...
void cEqAppui_NoDist__PProjInc_M2CNoDist::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[0];
   double tmp1_ = mCompCoord[1];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][0] = (tmp145_)*mLocNDdx_x+(tmp157_)*mLocNDdy_x;
  mCompDer[0][1] = (tmp168_)*mLocNDdx_x+(tmp180_)*mLocNDdy_x;
  mCompDer[0][2] = (tmp183_)*mLocNDdx_x+(tmp199_)*mLocNDdy_x;
  mCompDer[0][3] = (tmp204_)*mLocNDdx_x+(tmp209_)*mLocNDdy_x;
  mCompDer[0][4] = (tmp214_)*mLocNDdx_x+(tmp219_)*mLocNDdy_x;
  mCompDer[0][5] = (tmp223_)*mLocNDdx_x+(tmp228_)*mLocNDdy_x;
  mCompDer[0][6] = (tmp237_)*mLocNDdx_x+(tmp246_)*mLocNDdy_x;
  mCompDer[0][7] = (tmp255_)*mLocNDdx_x+(tmp264_)*mLocNDdy_x;
  mCompDer[0][8] = (tmp273_)*mLocNDdx_x+(tmp282_)*mLocNDdy_x;
  mVal[1] = (mLocNDP0_y+mLocNDdx_y*(tmp136_)+mLocNDdy_y*(tmp137_))-mLocYIm;

  mCompDer[1][0] = (tmp145_)*mLocNDdx_y+(tmp157_)*mLocNDdy_y;
  mCompDer[1][1] = (tmp168_)*mLocNDdx_y+(tmp180_)*mLocNDdy_y;
  mCompDer[1][2] = (tmp183_)*mLocNDdx_y+(tmp199_)*mLocNDdy_y;
  mCompDer[1][3] = (tmp204_)*mLocNDdx_y+(tmp209_)*mLocNDdy_y;
  mCompDer[1][4] = (tmp214_)*mLocNDdx_y+(tmp219_)*mLocNDdy_y;
  mCompDer[1][5] = (tmp223_)*mLocNDdx_y+(tmp228_)*mLocNDdy_y;
  mCompDer[1][6] = (tmp237_)*mLocNDdx_y+(tmp246_)*mLocNDdy_y;
  mCompDer[1][7] = (tmp255_)*mLocNDdx_y+(tmp264_)*mLocNDdy_y;
  mCompDer[1][8] = (tmp273_)*mLocNDdx_y+(tmp282_)*mLocNDdy_y;
}


void cEqAppui_NoDist__PProjInc_M2CNoDist::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PProjInc_M2CNoDist Has no Der Sec");
}

void cEqAppui_NoDist__PProjInc_M2CNoDist::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CNoDist::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PProjInc_M2CNoDist::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PProjInc_M2CNoDist::mTheAuto("cEqAppui_NoDist__PProjInc_M2CNoDist",cEqAppui_NoDist__PProjInc_M2CNoDist::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PProjInc_M2CNoDist::Alloc()
{  return new cEqAppui_NoDist__PProjInc_M2CNoDist();
}
