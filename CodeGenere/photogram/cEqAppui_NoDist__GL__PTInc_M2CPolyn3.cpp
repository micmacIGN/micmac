...
#include "cEqAppui_NoDist__GL__PTInc_M2CPolyn3.h"


cEqAppui_NoDist__GL__PTInc_M2CPolyn3::cEqAppui_NoDist__GL__PTInc_M2CPolyn3():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[17];
   double tmp1_ = mCompCoord[18];
   double tmp2_ = cos(tmp1_);
...
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CPolyn3 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn3::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CPolyn3::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CPolyn3::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CPolyn3",cEqAppui_NoDist__GL__PTInc_M2CPolyn3::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CPolyn3::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CPolyn3();
}
