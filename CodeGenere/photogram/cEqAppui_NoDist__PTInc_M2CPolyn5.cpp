...
#include "cEqAppui_NoDist__PTInc_M2CPolyn5.h"


cEqAppui_NoDist__PTInc_M2CPolyn5::cEqAppui_NoDist__PTInc_M2CPolyn5():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PTInc_M2CPolyn5::ComputeVal()
{
...
void cEqAppui_NoDist__PTInc_M2CPolyn5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[39];
   double tmp1_ = mCompCoord[40];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][37] = 0;
  mCompDer[0][38] = 0;
  mCompDer[0][39] = (tmp105_)*mLocNDdx_x+(tmp117_)*mLocNDdy_x;
  mCompDer[0][40] = (tmp128_)*mLocNDdx_x+(tmp140_)*mLocNDdy_x;
  mCompDer[0][41] = (tmp143_)*mLocNDdx_x+(tmp159_)*mLocNDdy_x;
  mCompDer[0][42] = (tmp164_)*mLocNDdx_x+(tmp169_)*mLocNDdy_x;
  mCompDer[0][43] = (tmp174_)*mLocNDdx_x+(tmp179_)*mLocNDdy_x;
  mCompDer[0][44] = (tmp183_)*mLocNDdx_x+(tmp188_)*mLocNDdy_x;
  mCompDer[0][45] = (tmp192_)*mLocNDdx_x+(tmp196_)*mLocNDdy_x;
  mCompDer[0][46] = (tmp200_)*mLocNDdx_x+(tmp204_)*mLocNDdy_x;
  mCompDer[0][47] = (tmp208_)*mLocNDdx_x+(tmp212_)*mLocNDdy_x;
  ...
  mCompDer[1][37] = 0;
  mCompDer[1][38] = 0;
  mCompDer[1][39] = (tmp105_)*mLocNDdx_y+(tmp117_)*mLocNDdy_y;
  mCompDer[1][40] = (tmp128_)*mLocNDdx_y+(tmp140_)*mLocNDdy_y;
  mCompDer[1][41] = (tmp143_)*mLocNDdx_y+(tmp159_)*mLocNDdy_y;
  mCompDer[1][42] = (tmp164_)*mLocNDdx_y+(tmp169_)*mLocNDdy_y;
  mCompDer[1][43] = (tmp174_)*mLocNDdx_y+(tmp179_)*mLocNDdy_y;
  mCompDer[1][44] = (tmp183_)*mLocNDdx_y+(tmp188_)*mLocNDdy_y;
  mCompDer[1][45] = (tmp192_)*mLocNDdx_y+(tmp196_)*mLocNDdy_y;
  mCompDer[1][46] = (tmp200_)*mLocNDdx_y+(tmp204_)*mLocNDdy_y;
  mCompDer[1][47] = (tmp208_)*mLocNDdx_y+(tmp212_)*mLocNDdy_y;
}


void cEqAppui_NoDist__PTInc_M2CPolyn5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PTInc_M2CPolyn5 Has no Der Sec");
}

void cEqAppui_NoDist__PTInc_M2CPolyn5::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn5::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn5::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn5::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn5::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn5::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn5::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PTInc_M2CPolyn5::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PTInc_M2CPolyn5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PTInc_M2CPolyn5::mTheAuto("cEqAppui_NoDist__PTInc_M2CPolyn5",cEqAppui_NoDist__PTInc_M2CPolyn5::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PTInc_M2CPolyn5::Alloc()
{  return new cEqAppui_NoDist__PTInc_M2CPolyn5();
}
