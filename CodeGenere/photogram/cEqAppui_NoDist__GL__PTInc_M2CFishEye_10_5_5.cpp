...
#include "cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5.h"


cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[53];
   double tmp1_ = mCompCoord[54];
   double tmp2_ = cos(tmp1_);
...
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5",cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CFishEye_10_5_5();
}
