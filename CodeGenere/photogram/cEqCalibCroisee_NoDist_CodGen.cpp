...
#include "cEqCalibCroisee_NoDist_CodGen.h"


cEqCalibCroisee_NoDist_CodGen::cEqCalibCroisee_NoDist_CodGen():
    cElCompiledFonc(3)
{
...
void cEqCalibCroisee_NoDist_CodGen::ComputeVal()
{
...
void cEqCalibCroisee_NoDist_CodGen::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[1];
   double tmp1_ = mLocPIm1_x-tmp0_;
   double tmp2_ = mCompCoord[0];
...
void cEqCalibCroisee_NoDist_CodGen::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqCalibCroisee_NoDist_CodGen Has no Der Sec");
}

void cEqCalibCroisee_NoDist_CodGen::SetDirEsp2_x(double aVal){ mLocDirEsp2_x = aVal;}
void cEqCalibCroisee_NoDist_CodGen::SetDirEsp2_y(double aVal){ mLocDirEsp2_y = aVal;}
void cEqCalibCroisee_NoDist_CodGen::SetDirEsp2_z(double aVal){ mLocDirEsp2_z = aVal;}
void cEqCalibCroisee_NoDist_CodGen::SetPIm1_x(double aVal){ mLocPIm1_x = aVal;}
void cEqCalibCroisee_NoDist_CodGen::SetPIm1_y(double aVal){ mLocPIm1_y = aVal;}



double * cEqCalibCroisee_NoDist_CodGen::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqCalibCroisee_NoDist_CodGen::mTheAuto("cEqCalibCroisee_NoDist_CodGen",cEqCalibCroisee_NoDist_CodGen::Alloc);


cElCompiledFonc *  cEqCalibCroisee_NoDist_CodGen::Alloc()
{  return new cEqCalibCroisee_NoDist_CodGen();
}
