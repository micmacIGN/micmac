...
#include "cEqAppui_NoDist__GL__PTInc_M2CPolyn5.h"


cEqAppui_NoDist__GL__PTInc_M2CPolyn5::cEqAppui_NoDist__GL__PTInc_M2CPolyn5():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[39];
   double tmp1_ = mCompCoord[40];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][37] = 0;
  mCompDer[0][38] = 0;
  mCompDer[0][39] = (tmp219_)*mLocNDdx_x+(tmp237_)*mLocNDdy_x;
  mCompDer[0][40] = (tmp261_)*mLocNDdx_x+(tmp285_)*mLocNDdy_x;
  mCompDer[0][41] = (tmp288_)*mLocNDdx_x+(tmp312_)*mLocNDdy_x;
  mCompDer[0][42] = (tmp317_)*mLocNDdx_x+(tmp322_)*mLocNDdy_x;
  mCompDer[0][43] = (tmp327_)*mLocNDdx_x+(tmp332_)*mLocNDdy_x;
  mCompDer[0][44] = (tmp337_)*mLocNDdx_x+(tmp342_)*mLocNDdy_x;
  mCompDer[0][45] = (tmp346_)*mLocNDdx_x+(tmp350_)*mLocNDdy_x;
  mCompDer[0][46] = (tmp354_)*mLocNDdx_x+(tmp358_)*mLocNDdy_x;
  mCompDer[0][47] = (tmp362_)*mLocNDdx_x+(tmp366_)*mLocNDdy_x;
  ...
  mCompDer[1][37] = 0;
  mCompDer[1][38] = 0;
  mCompDer[1][39] = (tmp219_)*mLocNDdx_y+(tmp237_)*mLocNDdy_y;
  mCompDer[1][40] = (tmp261_)*mLocNDdx_y+(tmp285_)*mLocNDdy_y;
  mCompDer[1][41] = (tmp288_)*mLocNDdx_y+(tmp312_)*mLocNDdy_y;
  mCompDer[1][42] = (tmp317_)*mLocNDdx_y+(tmp322_)*mLocNDdy_y;
  mCompDer[1][43] = (tmp327_)*mLocNDdx_y+(tmp332_)*mLocNDdy_y;
  mCompDer[1][44] = (tmp337_)*mLocNDdx_y+(tmp342_)*mLocNDdy_y;
  mCompDer[1][45] = (tmp346_)*mLocNDdx_y+(tmp350_)*mLocNDdy_y;
  mCompDer[1][46] = (tmp354_)*mLocNDdx_y+(tmp358_)*mLocNDdy_y;
  mCompDer[1][47] = (tmp362_)*mLocNDdx_y+(tmp366_)*mLocNDdy_y;
}


void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CPolyn5 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CPolyn5::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CPolyn5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CPolyn5::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CPolyn5",cEqAppui_NoDist__GL__PTInc_M2CPolyn5::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CPolyn5::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CPolyn5();
}
