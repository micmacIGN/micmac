...
#include "cEqResiduIm2DPol3Id.h"


cEqResiduIm2DPol3Id::cEqResiduIm2DPol3Id():
    cElCompiledFonc(1)
{
...
void cEqResiduIm2DPol3Id::ComputeVal()
{
   ...
   double tmp22_ = ElSquare(mLocYL1);
   double tmp23_ = mCompCoord[8];
   double tmp24_ = ElSquare(mLocXL1);
...
void cEqResiduIm2DPol3Id::ComputeValDeriv()
{
   double tmp0_ = ElSquare(mLocYL2);
   double tmp1_ = ElSquare(mLocXL2);
   double tmp2_ = mCompCoord[26];
   ...
   double tmp296_ = mLocYL1*tmp177_;
   double tmp297_ = tmp296_*(tmp158_);
   double tmp298_ = tmp295_+tmp297_;
   double tmp299_ = mLocYL2*tmp189_;
   ...
   double tmp340_ = mLocXL1*tmp177_;
   double tmp341_ = tmp340_*(tmp158_);
   double tmp342_ = tmp339_+tmp341_;
   double tmp343_ = mLocXL2*tmp189_;
   ...
   double tmp411_ = mLocXL2*mLocYL2;
   double tmp412_ = mLocXL1*mLocYL1;
   ...
   double tmp539_ = mLocXL2*tmp0_;
   double tmp540_ = mLocXL1*tmp22_;
   ...
   double tmp583_ = tmp1_*mLocYL2;
   double tmp584_ = tmp24_*mLocYL1;
   ...
   double tmp705_ = mLocYL2*(tmp138_);
   double tmp706_ = tmp705_*(tmp151_);
   double tmp707_ = mLocYL1*tmp147_;
   double tmp708_ = tmp707_*(tmp145_);
   double tmp709_ = tmp706_+tmp708_;
   double tmp710_ = mLocYL2*tmp154_;
   double tmp711_ = tmp710_*(tmp170_);
   double tmp712_ = mLocYL1*(tmp163_);
   ...
   double tmp718_ = mLocYL1*(tmp181_);
   double tmp719_ = tmp718_*(tmp158_);
   double tmp720_ = tmp717_+tmp719_;
   double tmp721_ = mLocYL2*(tmp193_);
   ...
   double tmp747_ = mLocXL2*(tmp138_);
   double tmp748_ = tmp747_*(tmp151_);
   double tmp749_ = mLocXL1*tmp147_;
   double tmp750_ = tmp749_*(tmp145_);
   double tmp751_ = tmp748_+tmp750_;
   double tmp752_ = mLocXL2*tmp154_;
   double tmp753_ = tmp752_*(tmp170_);
   double tmp754_ = mLocXL1*(tmp163_);
   ...
   double tmp760_ = mLocXL1*(tmp181_);
   double tmp761_ = tmp760_*(tmp158_);
   double tmp762_ = tmp759_+tmp761_;
   double tmp763_ = mLocXL2*(tmp193_);
   ...
   double tmp1083_ = -(1);
   double tmp1084_ = tmp1083_*tmp107_;
   double tmp1085_ = tmp1084_*tmp106_;
   double tmp1086_ = tmp1085_+tmp180_;
   double tmp1087_ = (tmp1086_)*(tmp130_);
   double tmp1088_ = tmp178_+tmp1087_;
   double tmp1089_ = tmp1084_*tmp166_;
   double tmp1090_ = tmp1089_+tmp185_;
   double tmp1091_ = tmp1088_+tmp1090_;
   double tmp1092_ = (tmp1091_)*(tmp158_);
   double tmp1093_ = -(tmp1092_);
   double tmp1094_ = tmp1093_*(tmp172_);
   double tmp1095_ = -(tmp131_);
   double tmp1096_ = tmp1084_*tmp132_;
   double tmp1097_ = tmp1084_*tmp39_;
   double tmp1098_ = tmp1097_*(tmp104_);
   double tmp1099_ = tmp1095_*tmp106_;
   double tmp1100_ = tmp1096_*tmp109_;
   double tmp1101_ = tmp1099_+tmp1100_;
   double tmp1102_ = (tmp1101_)*(tmp130_);
   double tmp1103_ = tmp1098_+tmp1102_;
   double tmp1104_ = tmp1095_*tmp166_;
   double tmp1105_ = tmp1096_*tmp106_;
   double tmp1106_ = tmp1104_+tmp1105_;
   double tmp1107_ = tmp1103_+tmp1106_;
   double tmp1108_ = (tmp1107_)*(tmp158_);
   double tmp1109_ = tmp1108_*(tmp201_);
   double tmp1110_ = (tmp1091_)*(tmp199_);
   double tmp1111_ = (tmp1107_)*(tmp145_);
   double tmp1112_ = tmp1110_-tmp1111_;
   double tmp1113_ = (tmp1112_)*(tmp204_);
   double tmp1114_ = (tmp1091_)*(tmp207_);
   double tmp1115_ = -(tmp1114_);
   double tmp1116_ = (tmp1107_)*(tmp207_);
   double tmp1117_ = (tmp1091_)*(tmp210_);
   double tmp1118_ = (tmp1107_)*(tmp213_);
   double tmp1119_ = tmp1117_-tmp1118_;
   double tmp1120_ = tmp1083_*tmp108_;
   double tmp1121_ = -(tmp39_);
   double tmp1122_ = tmp1121_*tmp107_;
   double tmp1123_ = tmp39_*(tmp104_);
   double tmp1124_ = tmp1120_*tmp109_;
   double tmp1125_ = tmp1124_*(tmp130_);
   double tmp1126_ = tmp1123_+tmp1125_;
   double tmp1127_ = tmp1120_*tmp106_;
   double tmp1128_ = tmp1126_+tmp1127_;
   double tmp1129_ = (tmp1128_)*(tmp145_);
   double tmp1130_ = tmp1120_*tmp107_;
   double tmp1131_ = tmp1130_*(tmp104_);
   double tmp1132_ = tmp1122_*tmp109_;
   double tmp1133_ = tmp1132_*(tmp130_);
   double tmp1134_ = tmp1131_+tmp1133_;
   double tmp1135_ = tmp1122_*tmp106_;
   double tmp1136_ = tmp1134_+tmp1135_;
   double tmp1137_ = (tmp1136_)*(tmp158_);
   double tmp1138_ = tmp1129_-tmp1137_;
   double tmp1139_ = (tmp1138_)*(tmp172_);
   double tmp1140_ = tmp1121_*tmp131_;
   double tmp1141_ = tmp1120_*tmp131_;
   double tmp1142_ = tmp1141_*(tmp104_);
   double tmp1143_ = tmp1140_*tmp109_;
   double tmp1144_ = tmp1143_*(tmp130_);
   double tmp1145_ = tmp1142_+tmp1144_;
   double tmp1146_ = tmp1140_*tmp106_;
   double tmp1147_ = tmp1145_+tmp1146_;
   double tmp1148_ = (tmp1147_)*(tmp158_);
   double tmp1149_ = (tmp1128_)*(tmp199_);
   double tmp1150_ = tmp1148_-tmp1149_;
   double tmp1151_ = (tmp1150_)*(tmp201_);
   double tmp1152_ = (tmp1136_)*(tmp199_);
   double tmp1153_ = (tmp1147_)*(tmp145_);
   double tmp1154_ = tmp1152_-tmp1153_;
   double tmp1155_ = (tmp1154_)*(tmp204_);
   double tmp1156_ = (tmp1128_)*(tmp213_);
   double tmp1157_ = (tmp1136_)*(tmp207_);
   double tmp1158_ = tmp1156_-tmp1157_;
   double tmp1159_ = (tmp1147_)*(tmp207_);
   double tmp1160_ = (tmp1128_)*(tmp210_);
   double tmp1161_ = tmp1159_-tmp1160_;
   double tmp1162_ = (tmp1136_)*(tmp210_);
   double tmp1163_ = (tmp1147_)*(tmp213_);
   double tmp1164_ = tmp1162_-tmp1163_;
   double tmp1165_ = tmp1083_*tmp109_;
   double tmp1166_ = tmp106_*tmp39_;
   double tmp1167_ = tmp1166_*(tmp130_);
   double tmp1168_ = tmp1165_*tmp39_;
   double tmp1169_ = tmp1167_+tmp1168_;
   double tmp1170_ = (tmp1169_)*(tmp145_);
   double tmp1171_ = tmp1165_*tmp131_;
   double tmp1172_ = tmp106_*tmp133_;
   double tmp1173_ = tmp1171_+tmp1172_;
   double tmp1174_ = (tmp1173_)*(tmp130_);
   double tmp1175_ = -(tmp106_);
   double tmp1176_ = tmp1175_*tmp131_;
   double tmp1177_ = tmp1165_*tmp133_;
   double tmp1178_ = tmp1176_+tmp1177_;
   double tmp1179_ = tmp1174_+tmp1178_;
   double tmp1180_ = (tmp1179_)*(tmp158_);
   double tmp1181_ = tmp1170_-tmp1180_;
   double tmp1182_ = (tmp1181_)*(tmp172_);
   double tmp1183_ = tmp1165_*tmp173_;
   double tmp1184_ = tmp106_*tmp174_;
   double tmp1185_ = tmp1183_+tmp1184_;
   double tmp1186_ = (tmp1185_)*(tmp130_);
   double tmp1187_ = tmp1175_*tmp173_;
   double tmp1188_ = tmp1165_*tmp174_;
   double tmp1189_ = tmp1187_+tmp1188_;
   double tmp1190_ = tmp1186_+tmp1189_;
   double tmp1191_ = (tmp1190_)*(tmp158_);
   double tmp1192_ = (tmp1169_)*(tmp199_);
   double tmp1193_ = tmp1191_-tmp1192_;
   double tmp1194_ = (tmp1193_)*(tmp201_);
   double tmp1195_ = (tmp1179_)*(tmp199_);
   double tmp1196_ = (tmp1190_)*(tmp145_);
   double tmp1197_ = tmp1195_-tmp1196_;
   double tmp1198_ = (tmp1197_)*(tmp204_);
   double tmp1199_ = (tmp1169_)*(tmp213_);
   double tmp1200_ = (tmp1179_)*(tmp207_);
   double tmp1201_ = tmp1199_-tmp1200_;
   double tmp1202_ = (tmp1190_)*(tmp207_);
   double tmp1203_ = (tmp1169_)*(tmp210_);
   double tmp1204_ = tmp1202_-tmp1203_;
   double tmp1205_ = (tmp1179_)*(tmp210_);
   double tmp1206_ = (tmp1190_)*(tmp213_);
   double tmp1207_ = tmp1205_-tmp1206_;
   double tmp1208_ = tmp1083_*(tmp151_);
   double tmp1209_ = -(tmp1208_);
   double tmp1210_ = tmp1083_*(tmp170_);
   double tmp1211_ = tmp1083_*(tmp187_);
   double tmp1212_ = -(tmp1211_);
   double tmp1213_ = -(tmp1210_);
   double tmp1214_ = tmp1083_*tmp3_;
   double tmp1215_ = tmp1214_*tmp13_;
   double tmp1216_ = tmp1215_+tmp192_;
   double tmp1217_ = (tmp1216_)*(tmp83_);
   double tmp1218_ = tmp190_+tmp1217_;
   double tmp1219_ = tmp1214_*tmp141_;
   double tmp1220_ = tmp1219_+tmp197_;
   double tmp1221_ = tmp1218_+tmp1220_;
   double tmp1222_ = (tmp1221_)*(tmp151_);
   double tmp1223_ = tmp1222_*(tmp172_);
   double tmp1224_ = -(tmp8_);
   double tmp1225_ = tmp1214_*tmp11_;
   double tmp1226_ = tmp1214_*tmp62_;
   double tmp1227_ = tmp1226_*(tmp61_);
   double tmp1228_ = tmp1224_*tmp13_;
   double tmp1229_ = tmp1225_*tmp9_;
   double tmp1230_ = tmp1228_+tmp1229_;
   double tmp1231_ = (tmp1230_)*(tmp83_);
   double tmp1232_ = tmp1227_+tmp1231_;
   double tmp1233_ = tmp1224_*tmp141_;
   double tmp1234_ = tmp1225_*tmp13_;
   double tmp1235_ = tmp1233_+tmp1234_;
   double tmp1236_ = tmp1232_+tmp1235_;
   double tmp1237_ = (tmp1236_)*(tmp151_);
   double tmp1238_ = -(tmp1237_);
   double tmp1239_ = tmp1238_*(tmp201_);
   double tmp1240_ = (tmp1236_)*(tmp170_);
   double tmp1241_ = (tmp1221_)*(tmp187_);
   double tmp1242_ = tmp1240_-tmp1241_;
   double tmp1243_ = (tmp1242_)*(tmp204_);
   double tmp1244_ = (tmp1236_)*(tmp199_);
   double tmp1245_ = (tmp1221_)*(tmp145_);
   double tmp1246_ = -(tmp62_);
   double tmp1247_ = tmp1246_*tmp3_;
   double tmp1248_ = tmp1083_*tmp10_;
   double tmp1249_ = tmp1248_*tmp3_;
   double tmp1250_ = tmp1249_*(tmp61_);
   double tmp1251_ = tmp1247_*tmp9_;
   double tmp1252_ = tmp1251_*(tmp83_);
   double tmp1253_ = tmp1250_+tmp1252_;
   double tmp1254_ = tmp1247_*tmp13_;
   double tmp1255_ = tmp1253_+tmp1254_;
   double tmp1256_ = (tmp1255_)*(tmp151_);
   double tmp1257_ = tmp62_*(tmp61_);
   double tmp1258_ = tmp1248_*tmp9_;
   double tmp1259_ = tmp1258_*(tmp83_);
   double tmp1260_ = tmp1257_+tmp1259_;
   double tmp1261_ = tmp1248_*tmp13_;
   double tmp1262_ = tmp1260_+tmp1261_;
   double tmp1263_ = (tmp1262_)*(tmp170_);
   double tmp1264_ = tmp1256_-tmp1263_;
   double tmp1265_ = (tmp1264_)*(tmp172_);
   double tmp1266_ = tmp1246_*tmp8_;
   double tmp1267_ = (tmp1262_)*(tmp187_);
   double tmp1268_ = tmp1248_*tmp8_;
   double tmp1269_ = tmp1268_*(tmp61_);
   double tmp1270_ = tmp1266_*tmp9_;
   double tmp1271_ = tmp1270_*(tmp83_);
   double tmp1272_ = tmp1269_+tmp1271_;
   double tmp1273_ = tmp1266_*tmp13_;
   double tmp1274_ = tmp1272_+tmp1273_;
   double tmp1275_ = (tmp1274_)*(tmp151_);
   double tmp1276_ = tmp1267_-tmp1275_;
   double tmp1277_ = (tmp1276_)*(tmp201_);
   double tmp1278_ = (tmp1274_)*(tmp170_);
   double tmp1279_ = (tmp1255_)*(tmp187_);
   double tmp1280_ = tmp1278_-tmp1279_;
   double tmp1281_ = (tmp1280_)*(tmp204_);
   double tmp1282_ = (tmp1274_)*(tmp199_);
   double tmp1283_ = (tmp1255_)*(tmp145_);
   double tmp1284_ = (tmp1262_)*(tmp158_);
   double tmp1285_ = tmp1083_*tmp9_;
   double tmp1286_ = tmp1285_*tmp8_;
   double tmp1287_ = tmp13_*tmp12_;
   double tmp1288_ = tmp1286_+tmp1287_;
   double tmp1289_ = (tmp1288_)*(tmp83_);
   double tmp1290_ = -(tmp13_);
   double tmp1291_ = tmp1290_*tmp8_;
   double tmp1292_ = tmp1285_*tmp12_;
   double tmp1293_ = tmp1291_+tmp1292_;
   double tmp1294_ = tmp1289_+tmp1293_;
   double tmp1295_ = (tmp1294_)*(tmp151_);
   double tmp1296_ = tmp13_*tmp62_;
   double tmp1297_ = tmp1296_*(tmp83_);
   double tmp1298_ = tmp1285_*tmp62_;
   double tmp1299_ = tmp1297_+tmp1298_;
   double tmp1300_ = (tmp1299_)*(tmp170_);
   double tmp1301_ = tmp1295_-tmp1300_;
   double tmp1302_ = (tmp1301_)*(tmp172_);
   double tmp1303_ = (tmp1299_)*(tmp187_);
   double tmp1304_ = tmp1285_*tmp175_;
   double tmp1305_ = tmp13_*tmp176_;
   double tmp1306_ = tmp1304_+tmp1305_;
   double tmp1307_ = (tmp1306_)*(tmp83_);
   double tmp1308_ = tmp1290_*tmp175_;
   double tmp1309_ = tmp1285_*tmp176_;
   double tmp1310_ = tmp1308_+tmp1309_;
   double tmp1311_ = tmp1307_+tmp1310_;
   double tmp1312_ = (tmp1311_)*(tmp151_);
   double tmp1313_ = tmp1303_-tmp1312_;
   double tmp1314_ = (tmp1313_)*(tmp201_);
   double tmp1315_ = (tmp1311_)*(tmp170_);
   double tmp1316_ = (tmp1294_)*(tmp187_);
   double tmp1317_ = tmp1315_-tmp1316_;
   double tmp1318_ = (tmp1317_)*(tmp204_);
   double tmp1319_ = (tmp1311_)*(tmp199_);
   double tmp1320_ = (tmp1294_)*(tmp145_);
   double tmp1321_ = (tmp1299_)*(tmp158_);
  ...
  mCompDer[0][20] = ((((0.500000*(tmp1094_+tmp1094_+tmp1109_+tmp1109_+tmp1113_+tmp1113_))/tmp252_)*tmp258_)/tmp316_)*(tmp272_)+(((tmp1115_*(tmp199_)+tmp1116_*(tmp145_)+(tmp1119_)*(tmp158_))*(tmp271_)-(tmp266_)*(tmp1115_*(tmp172_)+tmp1093_*(tmp216_)+tmp1116_*(tmp201_)+tmp1108_*(tmp219_)+(tmp1119_)*(tmp204_)+(tmp1112_)*(tmp222_)))/tmp326_)*(tmp282_);
  mCompDer[0][21] = ((((0.500000*(tmp1139_+tmp1139_+tmp1151_+tmp1151_+tmp1155_+tmp1155_))/tmp252_)*tmp258_)/tmp316_)*(tmp272_)+((((tmp1158_)*(tmp199_)+(tmp1161_)*(tmp145_)+(tmp1164_)*(tmp158_))*(tmp271_)-(tmp266_)*((tmp1158_)*(tmp172_)+(tmp1138_)*(tmp216_)+(tmp1161_)*(tmp201_)+(tmp1150_)*(tmp219_)+(tmp1164_)*(tmp204_)+(tmp1154_)*(tmp222_)))/tmp326_)*(tmp282_);
  mCompDer[0][22] = ((((0.500000*(tmp1182_+tmp1182_+tmp1194_+tmp1194_+tmp1198_+tmp1198_))/tmp252_)*tmp258_)/tmp316_)*(tmp272_)+((((tmp1201_)*(tmp199_)+(tmp1204_)*(tmp145_)+(tmp1207_)*(tmp158_))*(tmp271_)-(tmp266_)*((tmp1201_)*(tmp172_)+(tmp1181_)*(tmp216_)+(tmp1204_)*(tmp201_)+(tmp1193_)*(tmp219_)+(tmp1207_)*(tmp204_)+(tmp1197_)*(tmp222_)))/tmp326_)*(tmp282_);
  mCompDer[0][23] = (((tmp1209_*(tmp145_)+tmp1210_*(tmp158_))*(tmp271_)-(tmp266_)*(tmp1209_*(tmp201_)+tmp1210_*(tmp204_)))/tmp326_)*(tmp282_);
  mCompDer[0][24] = (((tmp1208_*(tmp199_)+tmp1212_*(tmp158_))*(tmp271_)-(tmp266_)*(tmp1208_*(tmp172_)+tmp1212_*(tmp204_)))/tmp326_)*(tmp282_);
  mCompDer[0][25] = (((tmp1213_*(tmp199_)+tmp1211_*(tmp145_))*(tmp271_)-(tmp266_)*(tmp1213_*(tmp172_)+tmp1211_*(tmp201_)))/tmp326_)*(tmp282_);
  mCompDer[0][26] = ((((0.500000*(tmp1223_+tmp1223_+tmp1239_+tmp1239_+tmp1243_+tmp1243_))/tmp252_)*tmp258_-tmp252_*((0.500000*(tmp1244_+tmp1244_+tmp1245_+tmp1245_))/tmp258_))/tmp316_)*(tmp272_)+((((tmp1236_)*(tmp216_)+(tmp1221_)*(tmp219_))*(tmp271_)-(tmp266_)*(tmp1222_*(tmp216_)+tmp1238_*(tmp219_)+(tmp1242_)*(tmp222_)))/tmp326_)*(tmp282_);
  mCompDer[0][27] = ((((0.500000*(tmp1265_+tmp1265_+tmp1277_+tmp1277_+tmp1281_+tmp1281_))/tmp252_)*tmp258_-tmp252_*((0.500000*(tmp1282_+tmp1282_+tmp1283_+tmp1283_+tmp1284_+tmp1284_))/tmp258_))/tmp316_)*(tmp272_)+((((tmp1274_)*(tmp216_)+(tmp1255_)*(tmp219_)+(tmp1262_)*(tmp222_))*(tmp271_)-(tmp266_)*((tmp1264_)*(tmp216_)+(tmp1276_)*(tmp219_)+(tmp1280_)*(tmp222_)))/tmp326_)*(tmp282_);
  mCompDer[0][28] = ((((0.500000*(tmp1302_+tmp1302_+tmp1314_+tmp1314_+tmp1318_+tmp1318_))/tmp252_)*tmp258_-tmp252_*((0.500000*(tmp1319_+tmp1319_+tmp1320_+tmp1320_+tmp1321_+tmp1321_))/tmp258_))/tmp316_)*(tmp272_)+((((tmp1311_)*(tmp216_)+(tmp1294_)*(tmp219_)+(tmp1299_)*(tmp222_))*(tmp271_)-(tmp266_)*((tmp1301_)*(tmp216_)+(tmp1313_)*(tmp219_)+(tmp1317_)*(tmp222_)))/tmp326_)*(tmp282_);
...
void cEqResiduIm2DPol3Id::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqResiduIm2DPol3Id Has no Der Sec");
}

void cEqResiduIm2DPol3Id::SetXL1(double aVal){ mLocXL1 = aVal;}
void cEqResiduIm2DPol3Id::SetXL2(double aVal){ mLocXL2 = aVal;}
void cEqResiduIm2DPol3Id::SetYL1(double aVal){ mLocYL1 = aVal;}
void cEqResiduIm2DPol3Id::SetYL2(double aVal){ mLocYL2 = aVal;}



double * cEqResiduIm2DPol3Id::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqResiduIm2DPol3Id::mTheAuto("cEqResiduIm2DPol3Id",cEqResiduIm2DPol3Id::Alloc);


cElCompiledFonc *  cEqResiduIm2DPol3Id::Alloc()
{  return new cEqResiduIm2DPol3Id();
}
