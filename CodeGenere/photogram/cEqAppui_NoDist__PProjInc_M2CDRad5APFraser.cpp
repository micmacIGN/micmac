...
#include "cEqAppui_NoDist__PProjInc_M2CDRad5APFraser.h"


cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::cEqAppui_NoDist__PProjInc_M2CDRad5APFraser():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::ComputeVal()
{
...
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[14];
   double tmp1_ = mCompCoord[15];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][12] = 0;
  mCompDer[0][13] = 0;
  mCompDer[0][14] = (tmp145_)*mLocNDdx_x+(tmp157_)*mLocNDdy_x;
  mCompDer[0][15] = (tmp168_)*mLocNDdx_x+(tmp180_)*mLocNDdy_x;
  mCompDer[0][16] = (tmp183_)*mLocNDdx_x+(tmp199_)*mLocNDdy_x;
  mCompDer[0][17] = (tmp204_)*mLocNDdx_x+(tmp209_)*mLocNDdy_x;
  mCompDer[0][18] = (tmp214_)*mLocNDdx_x+(tmp219_)*mLocNDdy_x;
  mCompDer[0][19] = (tmp223_)*mLocNDdx_x+(tmp228_)*mLocNDdy_x;
  mCompDer[0][20] = (tmp237_)*mLocNDdx_x+(tmp246_)*mLocNDdy_x;
  mCompDer[0][21] = (tmp255_)*mLocNDdx_x+(tmp264_)*mLocNDdy_x;
  mCompDer[0][22] = (tmp273_)*mLocNDdx_x+(tmp282_)*mLocNDdy_x;
  ...
  mCompDer[1][12] = 0;
  mCompDer[1][13] = 0;
  mCompDer[1][14] = (tmp145_)*mLocNDdx_y+(tmp157_)*mLocNDdy_y;
  mCompDer[1][15] = (tmp168_)*mLocNDdx_y+(tmp180_)*mLocNDdy_y;
  mCompDer[1][16] = (tmp183_)*mLocNDdx_y+(tmp199_)*mLocNDdy_y;
  mCompDer[1][17] = (tmp204_)*mLocNDdx_y+(tmp209_)*mLocNDdy_y;
  mCompDer[1][18] = (tmp214_)*mLocNDdx_y+(tmp219_)*mLocNDdy_y;
  mCompDer[1][19] = (tmp223_)*mLocNDdx_y+(tmp228_)*mLocNDdy_y;
  mCompDer[1][20] = (tmp237_)*mLocNDdx_y+(tmp246_)*mLocNDdy_y;
  mCompDer[1][21] = (tmp255_)*mLocNDdx_y+(tmp264_)*mLocNDdy_y;
  mCompDer[1][22] = (tmp273_)*mLocNDdx_y+(tmp282_)*mLocNDdy_y;
}


void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PProjInc_M2CDRad5APFraser Has no Der Sec");
}

void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::mTheAuto("cEqAppui_NoDist__PProjInc_M2CDRad5APFraser",cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PProjInc_M2CDRad5APFraser::Alloc()
{  return new cEqAppui_NoDist__PProjInc_M2CDRad5APFraser();
}
