...
#include "cEqAppui_NoDist__GL__PProjInc_M2CNoDist.h"


cEqAppui_NoDist__GL__PProjInc_M2CNoDist::cEqAppui_NoDist__GL__PProjInc_M2CNoDist():
    cElCompiledFonc(2)
{
   AddIntRef (cIncIntervale("Intr",0,0));
...
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[0];
   double tmp1_ = mCompCoord[1];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][0] = (tmp259_)*mLocNDdx_x+(tmp277_)*mLocNDdy_x;
  mCompDer[0][1] = (tmp301_)*mLocNDdx_x+(tmp325_)*mLocNDdy_x;
  mCompDer[0][2] = (tmp328_)*mLocNDdx_x+(tmp352_)*mLocNDdy_x;
  mCompDer[0][3] = (tmp357_)*mLocNDdx_x+(tmp362_)*mLocNDdy_x;
  mCompDer[0][4] = (tmp367_)*mLocNDdx_x+(tmp372_)*mLocNDdy_x;
  mCompDer[0][5] = (tmp377_)*mLocNDdx_x+(tmp382_)*mLocNDdy_x;
  mCompDer[0][6] = (tmp391_)*mLocNDdx_x+(tmp400_)*mLocNDdy_x;
  mCompDer[0][7] = (tmp409_)*mLocNDdx_x+(tmp418_)*mLocNDdy_x;
  mCompDer[0][8] = (tmp427_)*mLocNDdx_x+(tmp436_)*mLocNDdy_x;
  mVal[1] = (mLocNDP0_y+mLocNDdx_y*(tmp240_)+mLocNDdy_y*(tmp241_))-mLocYIm;

  mCompDer[1][0] = (tmp259_)*mLocNDdx_y+(tmp277_)*mLocNDdy_y;
  mCompDer[1][1] = (tmp301_)*mLocNDdx_y+(tmp325_)*mLocNDdy_y;
  mCompDer[1][2] = (tmp328_)*mLocNDdx_y+(tmp352_)*mLocNDdy_y;
  mCompDer[1][3] = (tmp357_)*mLocNDdx_y+(tmp362_)*mLocNDdy_y;
  mCompDer[1][4] = (tmp367_)*mLocNDdx_y+(tmp372_)*mLocNDdy_y;
  mCompDer[1][5] = (tmp377_)*mLocNDdx_y+(tmp382_)*mLocNDdy_y;
  mCompDer[1][6] = (tmp391_)*mLocNDdx_y+(tmp400_)*mLocNDdy_y;
  mCompDer[1][7] = (tmp409_)*mLocNDdx_y+(tmp418_)*mLocNDdy_y;
  mCompDer[1][8] = (tmp427_)*mLocNDdx_y+(tmp436_)*mLocNDdy_y;
}


void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PProjInc_M2CNoDist Has no Der Sec");
}

void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CNoDist::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PProjInc_M2CNoDist::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PProjInc_M2CNoDist::mTheAuto("cEqAppui_NoDist__GL__PProjInc_M2CNoDist",cEqAppui_NoDist__GL__PProjInc_M2CNoDist::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PProjInc_M2CNoDist::Alloc()
{  return new cEqAppui_NoDist__GL__PProjInc_M2CNoDist();
}
