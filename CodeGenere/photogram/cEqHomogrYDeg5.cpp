...
#include "StdAfx.h"
#include "cEqHomogrYDeg5.h"


cEqHomogrYDeg5::cEqHomogrYDeg5():
    cElCompiledFonc(1)
{
...
void cEqHomogrYDeg5::ComputeVal()
{
  ...
  mVal[0] = (mCompCoord[3]*(tmp27_)+mCompCoord[4]*(tmp29_)+mCompCoord[5])/(mCompCoord[6]*(tmp27_)+mCompCoord[7]*(tmp29_)+1)-(mCompCoord[11]*(tmp50_)+mCompCoord[12]*(tmp52_)+mCompCoord[13])/(mCompCoord[14]*(tmp50_)+mCompCoord[15]*(tmp52_)+1);

}


void cEqHomogrYDeg5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[16];
   double tmp1_ = mLocXL1-tmp0_;
   double tmp2_ = mCompCoord[17];
   ...
   double tmp74_ = mCompCoord[11];
   double tmp75_ = tmp74_*(tmp50_);
   double tmp76_ = mCompCoord[12];
   double tmp77_ = tmp76_*(tmp52_);
   double tmp78_ = tmp75_+tmp77_;
   double tmp79_ = mCompCoord[13];
  ...
  mCompDer[0][1] = 0;
  mCompDer[0][2] = 0;
  mCompDer[0][3] = ((tmp27_)*(tmp58_))/tmp59_;
  mCompDer[0][4] = ((tmp29_)*(tmp58_))/tmp59_;
  mCompDer[0][5] = (tmp58_)/tmp59_;
  mCompDer[0][6] = -((tmp66_)*(tmp27_))/tmp59_;
  mCompDer[0][7] = -((tmp66_)*(tmp29_))/tmp59_;
  mCompDer[0][8] = 0;
  mCompDer[0][9] = 0;
  mCompDer[0][10] = 0;
  mCompDer[0][11] = -(((tmp50_)*(tmp72_))/tmp73_);
  mCompDer[0][12] = -(((tmp52_)*(tmp72_))/tmp73_);
  mCompDer[0][13] = -((tmp72_)/tmp73_);
...
void cEqHomogrYDeg5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqHomogrYDeg5 Has no Der Sec");
}

void cEqHomogrYDeg5::SetXL1(double aVal){ mLocXL1 = aVal;}
void cEqHomogrYDeg5::SetXL2(double aVal){ mLocXL2 = aVal;}
void cEqHomogrYDeg5::SetYL1(double aVal){ mLocYL1 = aVal;}
void cEqHomogrYDeg5::SetYL2(double aVal){ mLocYL2 = aVal;}



double * cEqHomogrYDeg5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqHomogrYDeg5::mTheAuto("cEqHomogrYDeg5",cEqHomogrYDeg5::Alloc);


cElCompiledFonc *  cEqHomogrYDeg5::Alloc()
{  return new cEqHomogrYDeg5();
}
