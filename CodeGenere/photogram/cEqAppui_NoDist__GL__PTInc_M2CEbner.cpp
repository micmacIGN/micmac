...
void cEqAppui_NoDist__GL__PTInc_M2CEbner::ComputeValDeriv()
{
  ...
  mCompDer[0][13] = 0;
  mCompDer[0][14] = 0;
  mCompDer[0][15] = (tmp219_)*mLocNDdx_x+(tmp237_)*mLocNDdy_x;
  mCompDer[0][16] = (tmp261_)*mLocNDdx_x+(tmp285_)*mLocNDdy_x;
  mCompDer[0][17] = (tmp288_)*mLocNDdx_x+(tmp312_)*mLocNDdy_x;
  mCompDer[0][18] = (tmp317_)*mLocNDdx_x+(tmp322_)*mLocNDdy_x;
  mCompDer[0][19] = (tmp327_)*mLocNDdx_x+(tmp332_)*mLocNDdy_x;
  mCompDer[0][20] = (tmp337_)*mLocNDdx_x+(tmp342_)*mLocNDdy_x;
  mCompDer[0][21] = (tmp346_)*mLocNDdx_x+(tmp350_)*mLocNDdy_x;
  mCompDer[0][22] = (tmp354_)*mLocNDdx_x+(tmp358_)*mLocNDdy_x;
  mCompDer[0][23] = (tmp362_)*mLocNDdx_x+(tmp366_)*mLocNDdy_x;
  ...
  mCompDer[1][13] = 0;
  mCompDer[1][14] = 0;
  mCompDer[1][15] = (tmp219_)*mLocNDdx_y+(tmp237_)*mLocNDdy_y;
  mCompDer[1][16] = (tmp261_)*mLocNDdx_y+(tmp285_)*mLocNDdy_y;
  mCompDer[1][17] = (tmp288_)*mLocNDdx_y+(tmp312_)*mLocNDdy_y;
  mCompDer[1][18] = (tmp317_)*mLocNDdx_y+(tmp322_)*mLocNDdy_y;
  mCompDer[1][19] = (tmp327_)*mLocNDdx_y+(tmp332_)*mLocNDdy_y;
  mCompDer[1][20] = (tmp337_)*mLocNDdx_y+(tmp342_)*mLocNDdy_y;
  mCompDer[1][21] = (tmp346_)*mLocNDdx_y+(tmp350_)*mLocNDdy_y;
  mCompDer[1][22] = (tmp354_)*mLocNDdx_y+(tmp358_)*mLocNDdy_y;
  mCompDer[1][23] = (tmp362_)*mLocNDdx_y+(tmp366_)*mLocNDdy_y;
}
