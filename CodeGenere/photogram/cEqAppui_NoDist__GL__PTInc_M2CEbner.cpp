...
#include "StdAfx.h"
#include "cEqAppui_NoDist__GL__PTInc_M2CEbner.h"


cEqAppui_NoDist__GL__PTInc_M2CEbner::cEqAppui_NoDist__GL__PTInc_M2CEbner():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CEbner::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CEbner::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[15];
   double tmp1_ = mCompCoord[16];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][13] = 0;
  mCompDer[0][14] = 0;
  mCompDer[0][15] = ((tmp219_)*mLocNDdx_x+(tmp237_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp261_)*mLocNDdx_x+(tmp285_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][17] = ((tmp288_)*mLocNDdx_x+(tmp312_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][18] = ((tmp317_)*mLocNDdx_x+(tmp322_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][19] = ((tmp327_)*mLocNDdx_x+(tmp332_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][20] = ((tmp337_)*mLocNDdx_x+(tmp342_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][21] = ((tmp346_)*mLocNDdx_x+(tmp350_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][22] = ((tmp354_)*mLocNDdx_x+(tmp358_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][23] = ((tmp362_)*mLocNDdx_x+(tmp366_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][13] = 0;
  mCompDer[1][14] = 0;
  mCompDer[1][15] = ((tmp219_)*mLocNDdx_y+(tmp237_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp261_)*mLocNDdx_y+(tmp285_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][17] = ((tmp288_)*mLocNDdx_y+(tmp312_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][18] = ((tmp317_)*mLocNDdx_y+(tmp322_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][19] = ((tmp327_)*mLocNDdx_y+(tmp332_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][20] = ((tmp337_)*mLocNDdx_y+(tmp342_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][21] = ((tmp346_)*mLocNDdx_y+(tmp350_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][22] = ((tmp354_)*mLocNDdx_y+(tmp358_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][23] = ((tmp362_)*mLocNDdx_y+(tmp366_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__GL__PTInc_M2CEbner::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CEbner Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CEbner::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CEbner::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CEbner::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CEbner",cEqAppui_NoDist__GL__PTInc_M2CEbner::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CEbner::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CEbner();
}
