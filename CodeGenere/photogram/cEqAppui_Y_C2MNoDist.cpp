...
#include "cEqAppui_Y_C2MNoDist.h"


cEqAppui_Y_C2MNoDist::cEqAppui_Y_C2MNoDist():
    cElCompiledFonc(1)
{
...
void cEqAppui_Y_C2MNoDist::ComputeVal()
{
...
void cEqAppui_Y_C2MNoDist::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[3];
   double tmp1_ = mCompCoord[5];
   double tmp2_ = cos(tmp0_);
...
void cEqAppui_Y_C2MNoDist::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_Y_C2MNoDist Has no Der Sec");
}

void cEqAppui_Y_C2MNoDist::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppui_Y_C2MNoDist::SetYIm(double aVal){ mLocYIm = aVal;}
void cEqAppui_Y_C2MNoDist::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppui_Y_C2MNoDist::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppui_Y_C2MNoDist::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_Y_C2MNoDist::mTheAuto("cEqAppui_Y_C2MNoDist",cEqAppui_Y_C2MNoDist::Alloc);


cElCompiledFonc *  cEqAppui_Y_C2MNoDist::Alloc()
{  return new cEqAppui_Y_C2MNoDist();
}
