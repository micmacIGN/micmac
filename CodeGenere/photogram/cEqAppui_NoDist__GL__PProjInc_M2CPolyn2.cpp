...
#include "cEqAppui_NoDist__GL__PProjInc_M2CPolyn2.h"


cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::cEqAppui_NoDist__GL__PProjInc_M2CPolyn2():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[9];
   double tmp1_ = mCompCoord[10];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][7] = 0;
  mCompDer[0][8] = 0;
  mCompDer[0][9] = (tmp259_)*mLocNDdx_x+(tmp277_)*mLocNDdy_x;
  mCompDer[0][10] = (tmp301_)*mLocNDdx_x+(tmp325_)*mLocNDdy_x;
  mCompDer[0][11] = (tmp328_)*mLocNDdx_x+(tmp352_)*mLocNDdy_x;
  mCompDer[0][12] = (tmp357_)*mLocNDdx_x+(tmp362_)*mLocNDdy_x;
  mCompDer[0][13] = (tmp367_)*mLocNDdx_x+(tmp372_)*mLocNDdy_x;
  mCompDer[0][14] = (tmp377_)*mLocNDdx_x+(tmp382_)*mLocNDdy_x;
  mCompDer[0][15] = (tmp391_)*mLocNDdx_x+(tmp400_)*mLocNDdy_x;
  mCompDer[0][16] = (tmp409_)*mLocNDdx_x+(tmp418_)*mLocNDdy_x;
  mCompDer[0][17] = (tmp427_)*mLocNDdx_x+(tmp436_)*mLocNDdy_x;
  ...
  mCompDer[1][7] = 0;
  mCompDer[1][8] = 0;
  mCompDer[1][9] = (tmp259_)*mLocNDdx_y+(tmp277_)*mLocNDdy_y;
  mCompDer[1][10] = (tmp301_)*mLocNDdx_y+(tmp325_)*mLocNDdy_y;
  mCompDer[1][11] = (tmp328_)*mLocNDdx_y+(tmp352_)*mLocNDdy_y;
  mCompDer[1][12] = (tmp357_)*mLocNDdx_y+(tmp362_)*mLocNDdy_y;
  mCompDer[1][13] = (tmp367_)*mLocNDdx_y+(tmp372_)*mLocNDdy_y;
  mCompDer[1][14] = (tmp377_)*mLocNDdx_y+(tmp382_)*mLocNDdy_y;
  mCompDer[1][15] = (tmp391_)*mLocNDdx_y+(tmp400_)*mLocNDdy_y;
  mCompDer[1][16] = (tmp409_)*mLocNDdx_y+(tmp418_)*mLocNDdy_y;
  mCompDer[1][17] = (tmp427_)*mLocNDdx_y+(tmp436_)*mLocNDdy_y;
}


void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PProjInc_M2CPolyn2 Has no Der Sec");
}

void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::mTheAuto("cEqAppui_NoDist__GL__PProjInc_M2CPolyn2",cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PProjInc_M2CPolyn2::Alloc()
{  return new cEqAppui_NoDist__GL__PProjInc_M2CPolyn2();
}
