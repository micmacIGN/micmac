...
void cEqAppui_NoDist__PProjInc_M2CEbner::ComputeValDeriv()
{
  ...
  mCompDer[0][13] = 0;
  mCompDer[0][14] = 0;
  mCompDer[0][15] = (tmp145_)*mLocNDdx_x+(tmp157_)*mLocNDdy_x;
  mCompDer[0][16] = (tmp168_)*mLocNDdx_x+(tmp180_)*mLocNDdy_x;
  mCompDer[0][17] = (tmp183_)*mLocNDdx_x+(tmp199_)*mLocNDdy_x;
  mCompDer[0][18] = (tmp204_)*mLocNDdx_x+(tmp209_)*mLocNDdy_x;
  mCompDer[0][19] = (tmp214_)*mLocNDdx_x+(tmp219_)*mLocNDdy_x;
  mCompDer[0][20] = (tmp223_)*mLocNDdx_x+(tmp228_)*mLocNDdy_x;
  mCompDer[0][21] = (tmp237_)*mLocNDdx_x+(tmp246_)*mLocNDdy_x;
  mCompDer[0][22] = (tmp255_)*mLocNDdx_x+(tmp264_)*mLocNDdy_x;
  mCompDer[0][23] = (tmp273_)*mLocNDdx_x+(tmp282_)*mLocNDdy_x;
  ...
  mCompDer[1][13] = 0;
  mCompDer[1][14] = 0;
  mCompDer[1][15] = (tmp145_)*mLocNDdx_y+(tmp157_)*mLocNDdy_y;
  mCompDer[1][16] = (tmp168_)*mLocNDdx_y+(tmp180_)*mLocNDdy_y;
  mCompDer[1][17] = (tmp183_)*mLocNDdx_y+(tmp199_)*mLocNDdy_y;
  mCompDer[1][18] = (tmp204_)*mLocNDdx_y+(tmp209_)*mLocNDdy_y;
  mCompDer[1][19] = (tmp214_)*mLocNDdx_y+(tmp219_)*mLocNDdy_y;
  mCompDer[1][20] = (tmp223_)*mLocNDdx_y+(tmp228_)*mLocNDdy_y;
  mCompDer[1][21] = (tmp237_)*mLocNDdx_y+(tmp246_)*mLocNDdy_y;
  mCompDer[1][22] = (tmp255_)*mLocNDdx_y+(tmp264_)*mLocNDdy_y;
  mCompDer[1][23] = (tmp273_)*mLocNDdx_y+(tmp282_)*mLocNDdy_y;
}
