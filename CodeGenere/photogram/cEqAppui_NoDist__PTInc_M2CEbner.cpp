...
void cEqAppui_NoDist__PTInc_M2CEbner::ComputeValDeriv()
{
  ...
  mCompDer[0][13] = 0;
  mCompDer[0][14] = 0;
  mCompDer[0][15] = (tmp105_)*mLocNDdx_x+(tmp117_)*mLocNDdy_x;
  mCompDer[0][16] = (tmp128_)*mLocNDdx_x+(tmp140_)*mLocNDdy_x;
  mCompDer[0][17] = (tmp143_)*mLocNDdx_x+(tmp159_)*mLocNDdy_x;
  mCompDer[0][18] = (tmp164_)*mLocNDdx_x+(tmp169_)*mLocNDdy_x;
  mCompDer[0][19] = (tmp174_)*mLocNDdx_x+(tmp179_)*mLocNDdy_x;
  mCompDer[0][20] = (tmp183_)*mLocNDdx_x+(tmp188_)*mLocNDdy_x;
  mCompDer[0][21] = (tmp192_)*mLocNDdx_x+(tmp196_)*mLocNDdy_x;
  mCompDer[0][22] = (tmp200_)*mLocNDdx_x+(tmp204_)*mLocNDdy_x;
  mCompDer[0][23] = (tmp208_)*mLocNDdx_x+(tmp212_)*mLocNDdy_x;
  ...
  mCompDer[1][13] = 0;
  mCompDer[1][14] = 0;
  mCompDer[1][15] = (tmp105_)*mLocNDdx_y+(tmp117_)*mLocNDdy_y;
  mCompDer[1][16] = (tmp128_)*mLocNDdx_y+(tmp140_)*mLocNDdy_y;
  mCompDer[1][17] = (tmp143_)*mLocNDdx_y+(tmp159_)*mLocNDdy_y;
  mCompDer[1][18] = (tmp164_)*mLocNDdx_y+(tmp169_)*mLocNDdy_y;
  mCompDer[1][19] = (tmp174_)*mLocNDdx_y+(tmp179_)*mLocNDdy_y;
  mCompDer[1][20] = (tmp183_)*mLocNDdx_y+(tmp188_)*mLocNDdy_y;
  mCompDer[1][21] = (tmp192_)*mLocNDdx_y+(tmp196_)*mLocNDdy_y;
  mCompDer[1][22] = (tmp200_)*mLocNDdx_y+(tmp204_)*mLocNDdy_y;
  mCompDer[1][23] = (tmp208_)*mLocNDdx_y+(tmp212_)*mLocNDdy_y;
}
