...
void cREgDistVal_EquiSolid_FishEye_10_5_5::ComputeValDeriv()
{
   ...
   double tmp28_ = ElSquare(mLocEquiSolid_FishEye_10_5_5_State_0_0);
   ...
   double tmp304_ = tmp303_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp305_ = 2 * tmp7_;
   double tmp306_ = tmp8_ + tmp305_;
   double tmp307_ = 4.000000 * tmp17_;
   double tmp308_ = tmp307_ * (tmp8_);
   double tmp309_ = tmp308_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp310_ = 6.000000 * tmp17_;
   double tmp311_ = tmp310_ * tmp9_;
   double tmp312_ = tmp311_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp313_ = 8.000000 * tmp17_;
   double tmp314_ = tmp313_ * tmp10_;
   double tmp315_ = tmp314_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp316_ = 10.000000 * tmp17_;
   double tmp317_ = tmp316_ * tmp11_;
   double tmp318_ = tmp317_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp319_ = (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp320_ = tmp19_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp321_ = tmp20_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp322_ = tmp21_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp323_ = tmp22_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp324_ = tmp23_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp325_ = tmp24_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp326_ = tmp192_ * (tmp2_);
   double tmp327_ = tmp186_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp328_ = tmp187_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp329_ = tmp188_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp330_ = tmp189_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
   double tmp331_ = tmp190_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;

  mVal[0] = (tmp0_ + (tmp2_ + (tmp2_) * (tmp59_) + tmp85_ * (tmp185_) + tmp87_ * tmp17_ + (tmp8_) * (tmp96_) + tmp9_ * (tmp106_) + tmp10_ * (tmp115_) + tmp11_ * (tmp124_) + tmp125_ * (tmp2_) + tmp170_ * (tmp5_) + tmp126_ * tmp19_ + tmp127_ * tmp20_ + tmp171_ * tmp21_ + tmp131_ * tmp22_ + tmp133_ * tmp23_ + tmp134_ * tmp24_ + tmp176_ * tmp25_ + tmp138_ * tmp186_ + tmp142_ * tmp187_ + tmp144_ * tmp188_ + tmp145_ * tmp189_ + tmp183_ * tmp190_) * mLocEquiSolid_FishEye_10_5_5_State_0_0) - mLocRegDistKnownVal_x;

  mCompDer[0][0] = 0;
  mCompDer[0][1] = 0;
  mCompDer[0][2] = 0;
  mCompDer[0][3] = 1 + (tmp29_ + tmp272_ + (tmp214_) * (tmp2_) + (tmp61_ + (tmp61_) * 2) * tmp85_ + tmp97_ * tmp87_ + (tmp61_) * (tmp96_) + ((tmp61_ + (tmp61_) * 4) * tmp88_ + tmp97_ * tmp94_) * (tmp8_) + (tmp63_) * (tmp106_) + ((tmp61_ + (tmp61_) * 6) * tmp98_ + tmp97_ * tmp104_) * tmp9_ + (tmp66_) * (tmp115_) + ((tmp61_ + (tmp61_) * 8) * tmp107_ + tmp97_ * tmp113_) * tmp10_ + (tmp69_) * (tmp124_) + ((tmp61_ + (tmp61_) * 10) * tmp116_ + tmp97_ * tmp122_) * tmp11_ + (tmp29_) * tmp125_ + (tmp130_) * tmp126_ + tmp132_ * tmp127_ + (tmp137_) * tmp131_ + (tmp141_) * tmp133_ + tmp143_ * tmp134_ + (tmp261_) * tmp138_ + (tmp265_) * tmp142_ + (tmp269_) * tmp144_ + tmp182_ * tmp145_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][4] = ((tmp294_) * (tmp2_) + (tmp146_) * tmp85_ + tmp60_ * tmp87_ + (tmp146_) * (tmp96_) + ((tmp146_) * tmp88_ + tmp60_ * tmp94_) * (tmp8_) + (tmp148_) * (tmp106_) + ((tmp146_) * tmp98_ + tmp60_ * tmp104_) * tmp9_ + (tmp151_) * (tmp115_) + ((tmp146_) * tmp107_ + tmp60_ * tmp113_) * tmp10_ + (tmp154_) * (tmp124_) + ((tmp146_) * tmp116_ + tmp60_ * tmp122_) * tmp11_ + tmp244_ + tmp172_ * tmp126_ + tmp173_ * tmp127_ + (tmp175_) * tmp171_ + tmp177_ * tmp131_ + tmp178_ * tmp133_ + tmp179_ * tmp134_ + (tmp181_) * tmp176_ + tmp296_ * tmp138_ + tmp297_ * tmp142_ + tmp298_ * tmp144_ + tmp299_ * tmp145_ + (tmp301_) * tmp183_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][5] = (tmp8_) * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][6] = tmp9_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][7] = tmp10_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][8] = tmp11_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][9] = tmp12_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][10] = tmp13_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][11] = tmp14_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][12] = tmp15_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][13] = tmp16_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][14] = tmp56_ * (tmp2_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][15] = (tmp185_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][16] = tmp304_;
  mCompDer[0][17] = (tmp90_) * (tmp8_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][18] = tmp309_;
  mCompDer[0][19] = (tmp100_) * tmp9_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][20] = tmp312_;
  mCompDer[0][21] = (tmp109_) * tmp10_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][22] = tmp315_;
  mCompDer[0][23] = (tmp118_) * tmp11_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][24] = tmp318_;
  mCompDer[0][25] = tmp319_;
  mCompDer[0][26] = (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][27] = 0;
  ...
  mCompDer[0][40] = 0;
  mCompDer[0][41] = tmp25_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[0][42] = 0;
  ...
  mCompDer[0][52] = 0;
  mVal[1] = (tmp3_ + (tmp5_ + (tmp5_) * (tmp59_) + tmp215_ * tmp17_ + tmp86_ * (tmp306_) + (tmp8_) * (tmp222_) + tmp9_ * (tmp229_) + tmp10_ * (tmp236_) + tmp11_ * (tmp243_) + tmp170_ * (tmp2_) + tmp245_ * tmp191_ + tmp246_ * tmp19_ + tmp247_ * tmp20_ + tmp295_ * tmp21_ + tmp251_ * tmp192_ + tmp252_ * tmp22_ + tmp253_ * tmp23_ + tmp254_ * tmp24_ + tmp258_ * tmp326_ + tmp262_ * tmp186_ + tmp266_ * tmp187_ + tmp270_ * tmp188_ + tmp271_ * tmp189_ + tmp302_ * tmp190_) * mLocEquiSolid_FishEye_10_5_5_State_0_0) - mLocRegDistKnownVal_y;

  mCompDer[1][0] = 0;
  mCompDer[1][1] = 0;
  mCompDer[1][2] = 0;
  mCompDer[1][3] = ((tmp214_) * (tmp5_) + tmp97_ * tmp215_ + (tmp61_) * tmp86_ + (tmp61_) * (tmp222_) + (tmp97_ * tmp217_ + (tmp61_) * tmp92_) * (tmp8_) + (tmp63_) * (tmp229_) + (tmp97_ * tmp224_ + (tmp61_) * tmp102_) * tmp9_ + (tmp66_) * (tmp236_) + (tmp97_ * tmp231_ + (tmp61_) * tmp111_) * tmp10_ + (tmp69_) * (tmp243_) + (tmp97_ * tmp238_ + (tmp61_) * tmp120_) * tmp11_ + tmp244_ + (tmp250_) * tmp245_ + (tmp130_) * tmp246_ + tmp132_ * tmp247_ + (tmp257_) * tmp251_ + (tmp137_) * tmp252_ + (tmp141_) * tmp253_ + tmp143_ * tmp254_ + ((tmp257_) * (tmp2_) + (tmp29_) * tmp192_) * tmp258_ + (tmp261_) * tmp262_ + (tmp265_) * tmp266_ + (tmp269_) * tmp270_ + tmp182_ * tmp271_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][4] = 1 + (tmp29_ + tmp272_ + (tmp294_) * (tmp5_) + tmp60_ * tmp215_ + (tmp146_ + (tmp146_) * 2) * tmp86_ + (tmp146_) * (tmp222_) + (tmp60_ * tmp217_ + (tmp146_ + (tmp146_) * 4) * tmp92_) * (tmp8_) + (tmp148_) * (tmp229_) + (tmp60_ * tmp224_ + (tmp146_ + (tmp146_) * 6) * tmp102_) * tmp9_ + (tmp151_) * (tmp236_) + (tmp60_ * tmp231_ + (tmp146_ + (tmp146_) * 8) * tmp111_) * tmp10_ + (tmp154_) * (tmp243_) + (tmp60_ * tmp238_ + (tmp146_ + (tmp146_) * 10) * tmp120_) * tmp11_ + tmp172_ * tmp246_ + tmp173_ * tmp247_ + (tmp175_) * tmp295_ + tmp177_ * tmp252_ + tmp178_ * tmp253_ + tmp179_ * tmp254_ + tmp296_ * tmp262_ + tmp297_ * tmp266_ + tmp298_ * tmp270_ + tmp299_ * tmp271_ + (tmp301_) * tmp302_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][5] = (tmp8_) * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][6] = tmp9_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][7] = tmp10_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][8] = tmp11_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][9] = tmp12_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][10] = tmp13_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][11] = tmp14_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][12] = tmp15_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][13] = tmp16_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][14] = tmp56_ * (tmp5_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][15] = tmp304_;
  mCompDer[1][16] = (tmp306_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][17] = tmp309_;
  mCompDer[1][18] = (tmp220_) * (tmp8_) * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][19] = tmp312_;
  mCompDer[1][20] = (tmp227_) * tmp9_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][21] = tmp315_;
  mCompDer[1][22] = (tmp234_) * tmp10_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][23] = tmp318_;
  mCompDer[1][24] = (tmp241_) * tmp11_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][25] = 0;
  mCompDer[1][26] = tmp319_;
  mCompDer[1][27] = tmp191_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][28] = 0;
  ...
  mCompDer[1][34] = tmp192_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][35] = 0;
  ...
  mCompDer[1][41] = 0;
  mCompDer[1][42] = tmp326_ * mLocEquiSolid_FishEye_10_5_5_State_0_0;
  mCompDer[1][43] = 0;
