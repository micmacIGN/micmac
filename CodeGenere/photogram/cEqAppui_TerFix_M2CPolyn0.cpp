...
#include "StdAfx.h"
#include "cEqAppui_TerFix_M2CPolyn0.h"


cEqAppui_TerFix_M2CPolyn0::cEqAppui_TerFix_M2CPolyn0():
    cElCompiledFonc(2)
{
...
void cEqAppui_TerFix_M2CPolyn0::ComputeVal()
{
...
void cEqAppui_TerFix_M2CPolyn0::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[3];
   double tmp1_ = mCompCoord[4];
   double tmp2_ = cos(tmp1_);
...
void cEqAppui_TerFix_M2CPolyn0::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_TerFix_M2CPolyn0 Has no Der Sec");
}

void cEqAppui_TerFix_M2CPolyn0::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_TerFix_M2CPolyn0::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_TerFix_M2CPolyn0::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppui_TerFix_M2CPolyn0::SetYIm(double aVal){ mLocYIm = aVal;}
void cEqAppui_TerFix_M2CPolyn0::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppui_TerFix_M2CPolyn0::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppui_TerFix_M2CPolyn0::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_TerFix_M2CPolyn0::mTheAuto("cEqAppui_TerFix_M2CPolyn0",cEqAppui_TerFix_M2CPolyn0::Alloc);


cElCompiledFonc *  cEqAppui_TerFix_M2CPolyn0::Alloc()
{  return new cEqAppui_TerFix_M2CPolyn0();
}
