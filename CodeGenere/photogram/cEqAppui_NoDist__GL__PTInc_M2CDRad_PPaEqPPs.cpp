...
#include "cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs.h"


cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[8];
   double tmp1_ = mCompCoord[9];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][6] = 0;
  mCompDer[0][7] = 0;
  mCompDer[0][8] = ((tmp219_)*mLocNDdx_x+(tmp237_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][9] = ((tmp261_)*mLocNDdx_x+(tmp285_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][10] = ((tmp288_)*mLocNDdx_x+(tmp312_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][11] = ((tmp317_)*mLocNDdx_x+(tmp322_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][12] = ((tmp327_)*mLocNDdx_x+(tmp332_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][13] = ((tmp337_)*mLocNDdx_x+(tmp342_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][14] = ((tmp346_)*mLocNDdx_x+(tmp350_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][15] = ((tmp354_)*mLocNDdx_x+(tmp358_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp362_)*mLocNDdx_x+(tmp366_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][6] = 0;
  mCompDer[1][7] = 0;
  mCompDer[1][8] = ((tmp219_)*mLocNDdx_y+(tmp237_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][9] = ((tmp261_)*mLocNDdx_y+(tmp285_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][10] = ((tmp288_)*mLocNDdx_y+(tmp312_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][11] = ((tmp317_)*mLocNDdx_y+(tmp322_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][12] = ((tmp327_)*mLocNDdx_y+(tmp332_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][13] = ((tmp337_)*mLocNDdx_y+(tmp342_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][14] = ((tmp346_)*mLocNDdx_y+(tmp350_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][15] = ((tmp354_)*mLocNDdx_y+(tmp358_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp362_)*mLocNDdx_y+(tmp366_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs Has no Der Sec");
}

void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::mTheAuto("cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs",cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs::Alloc()
{  return new cEqAppui_NoDist__GL__PTInc_M2CDRad_PPaEqPPs();
}
