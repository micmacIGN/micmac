...
#include "cEqAppui_NoDist__GL__PProjInc_M2CDCBrown.h"


cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::cEqAppui_NoDist__GL__PProjInc_M2CDCBrown():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[17];
   double tmp1_ = mCompCoord[18];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][15] = 0;
  mCompDer[0][16] = 0;
  mCompDer[0][17] = (tmp259_)*mLocNDdx_x+(tmp277_)*mLocNDdy_x;
  mCompDer[0][18] = (tmp301_)*mLocNDdx_x+(tmp325_)*mLocNDdy_x;
  mCompDer[0][19] = (tmp328_)*mLocNDdx_x+(tmp352_)*mLocNDdy_x;
  mCompDer[0][20] = (tmp357_)*mLocNDdx_x+(tmp362_)*mLocNDdy_x;
  mCompDer[0][21] = (tmp367_)*mLocNDdx_x+(tmp372_)*mLocNDdy_x;
  mCompDer[0][22] = (tmp377_)*mLocNDdx_x+(tmp382_)*mLocNDdy_x;
  mCompDer[0][23] = (tmp391_)*mLocNDdx_x+(tmp400_)*mLocNDdy_x;
  mCompDer[0][24] = (tmp409_)*mLocNDdx_x+(tmp418_)*mLocNDdy_x;
  mCompDer[0][25] = (tmp427_)*mLocNDdx_x+(tmp436_)*mLocNDdy_x;
  ...
  mCompDer[1][15] = 0;
  mCompDer[1][16] = 0;
  mCompDer[1][17] = (tmp259_)*mLocNDdx_y+(tmp277_)*mLocNDdy_y;
  mCompDer[1][18] = (tmp301_)*mLocNDdx_y+(tmp325_)*mLocNDdy_y;
  mCompDer[1][19] = (tmp328_)*mLocNDdx_y+(tmp352_)*mLocNDdy_y;
  mCompDer[1][20] = (tmp357_)*mLocNDdx_y+(tmp362_)*mLocNDdy_y;
  mCompDer[1][21] = (tmp367_)*mLocNDdx_y+(tmp372_)*mLocNDdy_y;
  mCompDer[1][22] = (tmp377_)*mLocNDdx_y+(tmp382_)*mLocNDdy_y;
  mCompDer[1][23] = (tmp391_)*mLocNDdx_y+(tmp400_)*mLocNDdy_y;
  mCompDer[1][24] = (tmp409_)*mLocNDdx_y+(tmp418_)*mLocNDdy_y;
  mCompDer[1][25] = (tmp427_)*mLocNDdx_y+(tmp436_)*mLocNDdy_y;
}


void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PProjInc_M2CDCBrown Has no Der Sec");
}

void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::mTheAuto("cEqAppui_NoDist__GL__PProjInc_M2CDCBrown",cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PProjInc_M2CDCBrown::Alloc()
{  return new cEqAppui_NoDist__GL__PProjInc_M2CDCBrown();
}
