...
#include "StdAfx.h"
#include "cEqAppui_NoDist__PProjInc_M2CPolyn0.h"


cEqAppui_NoDist__PProjInc_M2CPolyn0::cEqAppui_NoDist__PProjInc_M2CPolyn0():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PProjInc_M2CPolyn0::ComputeVal()
{
...
void cEqAppui_NoDist__PProjInc_M2CPolyn0::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[3];
   double tmp1_ = mCompCoord[4];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][1] = 0;
  mCompDer[0][2] = 0;
  mCompDer[0][3] = ((tmp138_) * mLocNDdx_x + (tmp150_) * mLocNDdy_x) * mLocScNorm;
  ...
  mCompDer[0][6] = ((tmp197_) * mLocNDdx_x + (tmp202_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][7] = ((tmp207_) * mLocNDdx_x + (tmp212_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][8] = ((tmp216_) * mLocNDdx_x + (tmp221_) * mLocNDdy_x) * mLocScNorm;
  ...
  mCompDer[0][11] = ((tmp266_) * mLocNDdx_x + (tmp275_) * mLocNDdy_x) * mLocScNorm;
  mVal[1] = ((mLocNDP0_y + mLocNDdx_y * (tmp129_) + mLocNDdy_y * (tmp130_)) - mLocYIm) * mLocScNorm;

  mCompDer[1][0] = 0;
  mCompDer[1][1] = 0;
  mCompDer[1][2] = 0;
  mCompDer[1][3] = ((tmp138_) * mLocNDdx_y + (tmp150_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][4] = ((tmp161_) * mLocNDdx_y + (tmp173_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][5] = ((tmp176_) * mLocNDdx_y + (tmp192_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][6] = ((tmp197_) * mLocNDdx_y + (tmp202_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][7] = ((tmp207_) * mLocNDdx_y + (tmp212_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][8] = ((tmp216_) * mLocNDdx_y + (tmp221_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][9] = ((tmp230_) * mLocNDdx_y + (tmp239_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][10] = ((tmp248_) * mLocNDdx_y + (tmp257_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][11] = ((tmp266_) * mLocNDdx_y + (tmp275_) * mLocNDdy_y) * mLocScNorm;
}


void cEqAppui_NoDist__PProjInc_M2CPolyn0::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PProjInc_M2CPolyn0 Has no Der Sec");
}

void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn0::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PProjInc_M2CPolyn0::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PProjInc_M2CPolyn0::mTheAuto("cEqAppui_NoDist__PProjInc_M2CPolyn0",cEqAppui_NoDist__PProjInc_M2CPolyn0::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PProjInc_M2CPolyn0::Alloc()
{  return new cEqAppui_NoDist__PProjInc_M2CPolyn0();
}
