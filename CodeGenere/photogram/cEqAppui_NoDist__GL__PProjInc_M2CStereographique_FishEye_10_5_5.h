...
class cEqAppui_NoDist__GL__PProjInc_M2CStereographique_FishEye_10_5_5: public cElCompiledFonc
{
   public :

      cEqAppui_NoDist__GL__PProjInc_M2CStereographique_FishEye_10_5_5();
      void ComputeVal();
