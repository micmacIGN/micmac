...
#include "cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs.h"


cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::ComputeVal()
{
...
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[12];
   double tmp1_ = mCompCoord[13];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][10] = 0;
  mCompDer[0][11] = 0;
  mCompDer[0][12] = ((tmp252_)*mLocNDdx_x+(tmp270_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][13] = ((tmp294_)*mLocNDdx_x+(tmp318_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][14] = ((tmp321_)*mLocNDdx_x+(tmp345_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][15] = ((tmp350_)*mLocNDdx_x+(tmp355_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][16] = ((tmp360_)*mLocNDdx_x+(tmp365_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][17] = ((tmp370_)*mLocNDdx_x+(tmp375_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][18] = ((tmp384_)*mLocNDdx_x+(tmp393_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][19] = ((tmp402_)*mLocNDdx_x+(tmp411_)*mLocNDdy_x)*mLocScNorm;
  mCompDer[0][20] = ((tmp420_)*mLocNDdx_x+(tmp429_)*mLocNDdy_x)*mLocScNorm;
  ...
  mCompDer[1][10] = 0;
  mCompDer[1][11] = 0;
  mCompDer[1][12] = ((tmp252_)*mLocNDdx_y+(tmp270_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][13] = ((tmp294_)*mLocNDdx_y+(tmp318_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][14] = ((tmp321_)*mLocNDdx_y+(tmp345_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][15] = ((tmp350_)*mLocNDdx_y+(tmp355_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][16] = ((tmp360_)*mLocNDdx_y+(tmp365_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][17] = ((tmp370_)*mLocNDdx_y+(tmp375_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][18] = ((tmp384_)*mLocNDdx_y+(tmp393_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][19] = ((tmp402_)*mLocNDdx_y+(tmp411_)*mLocNDdy_y)*mLocScNorm;
  mCompDer[1][20] = ((tmp420_)*mLocNDdx_y+(tmp429_)*mLocNDdy_y)*mLocScNorm;
}


void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs Has no Der Sec");
}

void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_0_0(double aVal){ mLocGL_0_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_0_1(double aVal){ mLocGL_0_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_0_2(double aVal){ mLocGL_0_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_1_0(double aVal){ mLocGL_1_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_1_1(double aVal){ mLocGL_1_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_1_2(double aVal){ mLocGL_1_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_2_0(double aVal){ mLocGL_2_0 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_2_1(double aVal){ mLocGL_2_1 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetGL_2_2(double aVal){ mLocGL_2_2 = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::mTheAuto("cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs",cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs::Alloc()
{  return new cEqAppui_NoDist__GL__PProjInc_M2CFraser_PPaEqPPs();
}
