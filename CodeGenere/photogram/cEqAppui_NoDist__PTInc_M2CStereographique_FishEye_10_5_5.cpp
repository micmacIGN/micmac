...
#include "StdAfx.h"
#include "cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5.h"


cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::ComputeVal()
{
  ...
  mVal[0] = ((mLocNDP0_x + mLocNDdx_x * (tmp42_) + mLocNDdy_x * (tmp55_)) - mLocXIm) * mLocScNorm;

  mVal[1] = ((mLocNDP0_y + mLocNDdx_y * (tmp42_) + mLocNDdy_y * (tmp55_)) - mLocYIm) * mLocScNorm;

}


void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[53];
   double tmp1_ = mCompCoord[54];
   double tmp2_ = cos(tmp1_);
  ...
  mVal[0] = ((mLocNDP0_x + mLocNDdx_x * (tmp96_) + mLocNDdy_x * (tmp97_)) - mLocXIm) * mLocScNorm;
  ...
  mCompDer[0][51] = 0;
  mCompDer[0][52] = 0;
  mCompDer[0][53] = ((tmp105_) * mLocNDdx_x + (tmp117_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][54] = ((tmp128_) * mLocNDdx_x + (tmp140_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][55] = ((tmp143_) * mLocNDdx_x + (tmp159_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][56] = ((tmp164_) * mLocNDdx_x + (tmp169_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][57] = ((tmp174_) * mLocNDdx_x + (tmp179_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][58] = ((tmp183_) * mLocNDdx_x + (tmp188_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][59] = ((tmp192_) * mLocNDdx_x + (tmp196_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][60] = ((tmp200_) * mLocNDdx_x + (tmp204_) * mLocNDdy_x) * mLocScNorm;
  mCompDer[0][61] = ((tmp208_) * mLocNDdx_x + (tmp212_) * mLocNDdy_x) * mLocScNorm;
  mVal[1] = ((mLocNDP0_y + mLocNDdx_y * (tmp96_) + mLocNDdy_y * (tmp97_)) - mLocYIm) * mLocScNorm;
  ...
  mCompDer[1][51] = 0;
  mCompDer[1][52] = 0;
  mCompDer[1][53] = ((tmp105_) * mLocNDdx_y + (tmp117_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][54] = ((tmp128_) * mLocNDdx_y + (tmp140_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][55] = ((tmp143_) * mLocNDdx_y + (tmp159_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][56] = ((tmp164_) * mLocNDdx_y + (tmp169_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][57] = ((tmp174_) * mLocNDdx_y + (tmp179_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][58] = ((tmp183_) * mLocNDdx_y + (tmp188_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][59] = ((tmp192_) * mLocNDdx_y + (tmp196_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][60] = ((tmp200_) * mLocNDdx_y + (tmp204_) * mLocNDdy_y) * mLocScNorm;
  mCompDer[1][61] = ((tmp208_) * mLocNDdx_y + (tmp212_) * mLocNDdy_y) * mLocScNorm;
}


void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5 Has no Der Sec");
}

void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetScNorm(double aVal){ mLocScNorm = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::mTheAuto("cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5",cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5::Alloc()
{  return new cEqAppui_NoDist__PTInc_M2CStereographique_FishEye_10_5_5();
}
