...
#include "cEqAppuiYDHom.h"


cEqAppuiYDHom::cEqAppuiYDHom():
    cElCompiledFonc(1)
{
...
void cEqAppuiYDHom::ComputeVal()
{
  ...
  mVal[0] = (mCompCoord[3]*(tmp39_)+mCompCoord[4]*(tmp52_)+mCompCoord[5])/(mCompCoord[6]*(tmp39_)+mCompCoord[7]*(tmp52_)+1)-mLocYIm;

}


void cEqAppuiYDHom::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[8];
   double tmp1_ = mCompCoord[9];
   double tmp2_ = cos(tmp1_);
  ...
  mVal[0] = (tmp66_)/(tmp58_)-mLocYIm;

  mCompDer[0][0] = 0;
  mCompDer[0][1] = 0;
  mCompDer[0][2] = 0;
  mCompDer[0][3] = ((tmp39_)*(tmp58_))/tmp59_;
  mCompDer[0][4] = ((tmp52_)*(tmp58_))/tmp59_;
...
void cEqAppuiYDHom::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppuiYDHom Has no Der Sec");
}

void cEqAppuiYDHom::SetXTer(double aVal){ mLocXTer = aVal;}
void cEqAppuiYDHom::SetYIm(double aVal){ mLocYIm = aVal;}
void cEqAppuiYDHom::SetYTer(double aVal){ mLocYTer = aVal;}
void cEqAppuiYDHom::SetZTer(double aVal){ mLocZTer = aVal;}



double * cEqAppuiYDHom::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppuiYDHom::mTheAuto("cEqAppuiYDHom",cEqAppuiYDHom::Alloc);


cElCompiledFonc *  cEqAppuiYDHom::Alloc()
{  return new cEqAppuiYDHom();
}
