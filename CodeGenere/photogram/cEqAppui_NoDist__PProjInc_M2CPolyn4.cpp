...
#include "cEqAppui_NoDist__PProjInc_M2CPolyn4.h"


cEqAppui_NoDist__PProjInc_M2CPolyn4::cEqAppui_NoDist__PProjInc_M2CPolyn4():
    cElCompiledFonc(2)
{
...
void cEqAppui_NoDist__PProjInc_M2CPolyn4::ComputeVal()
{
...
void cEqAppui_NoDist__PProjInc_M2CPolyn4::ComputeValDeriv()
{
   double tmp0_ = mCompCoord[27];
   double tmp1_ = mCompCoord[28];
   double tmp2_ = cos(tmp1_);
  ...
  mCompDer[0][25] = 0;
  mCompDer[0][26] = 0;
  mCompDer[0][27] = (tmp145_)*mLocNDdx_x+(tmp157_)*mLocNDdy_x;
  mCompDer[0][28] = (tmp168_)*mLocNDdx_x+(tmp180_)*mLocNDdy_x;
  mCompDer[0][29] = (tmp183_)*mLocNDdx_x+(tmp199_)*mLocNDdy_x;
  mCompDer[0][30] = (tmp204_)*mLocNDdx_x+(tmp209_)*mLocNDdy_x;
  mCompDer[0][31] = (tmp214_)*mLocNDdx_x+(tmp219_)*mLocNDdy_x;
  mCompDer[0][32] = (tmp223_)*mLocNDdx_x+(tmp228_)*mLocNDdy_x;
  mCompDer[0][33] = (tmp237_)*mLocNDdx_x+(tmp246_)*mLocNDdy_x;
  mCompDer[0][34] = (tmp255_)*mLocNDdx_x+(tmp264_)*mLocNDdy_x;
  mCompDer[0][35] = (tmp273_)*mLocNDdx_x+(tmp282_)*mLocNDdy_x;
  ...
  mCompDer[1][25] = 0;
  mCompDer[1][26] = 0;
  mCompDer[1][27] = (tmp145_)*mLocNDdx_y+(tmp157_)*mLocNDdy_y;
  mCompDer[1][28] = (tmp168_)*mLocNDdx_y+(tmp180_)*mLocNDdy_y;
  mCompDer[1][29] = (tmp183_)*mLocNDdx_y+(tmp199_)*mLocNDdy_y;
  mCompDer[1][30] = (tmp204_)*mLocNDdx_y+(tmp209_)*mLocNDdy_y;
  mCompDer[1][31] = (tmp214_)*mLocNDdx_y+(tmp219_)*mLocNDdy_y;
  mCompDer[1][32] = (tmp223_)*mLocNDdx_y+(tmp228_)*mLocNDdy_y;
  mCompDer[1][33] = (tmp237_)*mLocNDdx_y+(tmp246_)*mLocNDdy_y;
  mCompDer[1][34] = (tmp255_)*mLocNDdx_y+(tmp264_)*mLocNDdy_y;
  mCompDer[1][35] = (tmp273_)*mLocNDdx_y+(tmp282_)*mLocNDdy_y;
}


void cEqAppui_NoDist__PProjInc_M2CPolyn4::ComputeValDerivHessian()
{
  ELISE_ASSERT(false,"Foncteur cEqAppui_NoDist__PProjInc_M2CPolyn4 Has no Der Sec");
}

void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetNDP0_x(double aVal){ mLocNDP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetNDP0_y(double aVal){ mLocNDP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetNDdx_x(double aVal){ mLocNDdx_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetNDdx_y(double aVal){ mLocNDdx_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetNDdy_x(double aVal){ mLocNDdy_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetNDdy_y(double aVal){ mLocNDdy_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjI_x(double aVal){ mLocProjI_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjI_y(double aVal){ mLocProjI_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjI_z(double aVal){ mLocProjI_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjJ_x(double aVal){ mLocProjJ_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjJ_y(double aVal){ mLocProjJ_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjJ_z(double aVal){ mLocProjJ_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjK_x(double aVal){ mLocProjK_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjK_y(double aVal){ mLocProjK_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjK_z(double aVal){ mLocProjK_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjP0_x(double aVal){ mLocProjP0_x = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjP0_y(double aVal){ mLocProjP0_y = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetProjP0_z(double aVal){ mLocProjP0_z = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetXIm(double aVal){ mLocXIm = aVal;}
void cEqAppui_NoDist__PProjInc_M2CPolyn4::SetYIm(double aVal){ mLocYIm = aVal;}



double * cEqAppui_NoDist__PProjInc_M2CPolyn4::AdrVarLocFromString(const std::string & aName)
{
...
cElCompiledFonc::cAutoAddEntry cEqAppui_NoDist__PProjInc_M2CPolyn4::mTheAuto("cEqAppui_NoDist__PProjInc_M2CPolyn4",cEqAppui_NoDist__PProjInc_M2CPolyn4::Alloc);


cElCompiledFonc *  cEqAppui_NoDist__PProjInc_M2CPolyn4::Alloc()
{  return new cEqAppui_NoDist__PProjInc_M2CPolyn4();
}
