...
std::string  Mangling( eTestDump *) {return "3826F102ACBD0EB2FD3F";};
...
std::string  Mangling( cTD2REF *) {return "6473F9952CE96DACFC3F";};
...
std::string  Mangling( cTestDump *) {return "BF93586D67466C94FF3F";};
