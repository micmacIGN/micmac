...
const char * (theNameVar_SuperposImage[1087]) = {
"<GenCpp>\n",
"\n",
"\n",
"<Verbatim File=\".h.cpp\">\n",
...
"            <AllPts Nb=\"?\"  Type=\"string\"> </AllPts>\n",
"            <PtsCenter Nb=\"?\"  Type=\"string\"> </PtsCenter>\n",
...
"       <SectionName Nb=\"1\">\n",
"\n",
"             <!-- calcule le nuage carte de prof a partir de deux noms de fichiers l'un venant de\n",
"                  GenereRes , l'autre de GenereInput \n",
"             -->\n",
"             <KeyNuage Type=\"std::string\" Nb=\"1\"> </KeyNuage>\n",
"             <!-- Doit genere le nom du fichier xml de nuage -->\n",
"             <KeyResult   Type=\"std::string\" Nb=\"1\"> </KeyResult>\n",
"\n",
"             <ModeleNuageResult Type=\"std::string\" Nb=\"?\"> </ModeleNuageResult>\n",
"       </SectionName>\n",
"\n",
"       <PercFusion Nb=\"?\" Type=\"double\" Def=\"50.0\"> </PercFusion>\n",
"\n",
...
"             <InterneParalDoOnlyOneRes Nb=\"?\" Type=\"std::string\" Def=\"\"> </InterneParalDoOnlyOneRes>\n",
