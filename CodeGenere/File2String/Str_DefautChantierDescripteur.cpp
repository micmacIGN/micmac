#include "StdAfx.h"
const char * (theNameVar_DefautChantierDescripteur[2659]) = {
"<!--\n",
...
"                <CalcName> RHH#1/$1/Homol$2.#2  </CalcName>\n",
"                <Separateur > % </Separateur>\n",
"             </Direct>\n",
"	     <Inverse>\n",
"                <PatternTransform> RHH#1/(.*)/Homol(.*)\\.#2 </PatternTransform>\n",
"                <CalcName> $1  </CalcName>\n",
"                <CalcName> $2  </CalcName>\n",
"	     </Inverse>\n",
"        </Calcs>\n",
"        <Key>  NKS-RHH-Assoc-CplIm2Hom </Key>\n",
...
"          <IsParametrized>  true </IsParametrized>\n",
"          <Sets> \n",
"                 <PatternAccepteur> #3/(.*)\\.(#2)  </PatternAccepteur>\n",
"		 <SubDir>   RHH#1/ </SubDir>\n",
