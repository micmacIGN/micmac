#include "StdAfx.h"
const char * (theNameVar_DefautChantierDescripteur[3188]) = {
"<!--\n",
...
"            </Direct>\n",
"            <Inverse>\n",
"                <PatternTransform> PC-Ref-NH/RefNH-(.*)---(.*)-#1.dmp.xml  </PatternTransform>\n",
"                <CalcName>  $1  </CalcName>\n",
"                <CalcName>  $2  </CalcName>\n",
"            </Inverse>\n",
"        </Calcs>\n",
...
"          <IsParametrized>  true </IsParametrized>\n",
"          <Sets> \n",
"                 <PatternAccepteur>  RefNH-(.*)---(.*)-#1.dmp.xml  </PatternAccepteur>\n",
