...
Multitemporal datasets definitely improve the overall classification accuracy, and the same goes for single-date high resolution orthophotomosaics, acquired on optimal time-windows, by resulting in a very good overall accuracy of 84\%. 
}
