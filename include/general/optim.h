...
class AllocateurDInconnues
{
      public :
        ...
        Pt3d<Fonc_Num>  NewPt3(const std::string & aNameBloc,const std::string & aNameInc,REAL *,REAL*,REAL*,bool HasAlwaysInitialValue=false);
        Pt3d<Fonc_Num>            NewPt3(const std::string & aNameBloc,const std::string & aNameInc,Pt3dr &,bool HasAlwaysInitialValue=false);
        Pt2d<Fonc_Num>            NewPt2(const std::string & aNameBloc,const std::string & aNameInc,REAL*,REAL*,bool HasAlwaysInitialValue=false);
        Pt2d<Fonc_Num>            NewPt2(const std::string & aNameBloc,const std::string & aNameInc,Pt2dr &,bool HasAlwaysInitialValue=false);

        std::vector<Fonc_Num>            NewVectInc(const std::string & aNameBloc,const std::vector<std::string> & aNameInc,std::vector<double> &);

        TplElRotation3D<Fonc_Num> NewRot(const std::string & aNameBloc,const std::string & aNameInc,REAL *,REAL*,REAL*,REAL *,REAL*,REAL*);
        INT CurInc() const;
